...
- Location: tests/integration/apiValidation.spec.ts:7:5
...
Call log:
  - waiting for getByRole('option', { name: 'Other' })
    - locator resolved to <lightning-base-combobox-item role="option" lwc-4kb6kaqheak="" data-value="Other" exportparts="option" aria-checked="false" aria-selected="false" lwc-7co8ha3nedg-host="" id="combobox-button-778-5-778" data-item-id="combobox-button-778-5" class="slds-media slds-listbox__option slds-media_center slds-media_small slds-listbox__option_plain">…</lightning-base-combobox-item>
                        ...
                        - generic [ref=e1544]:
                          ...
                          - listitem [ref=e1562]:
                            ...
                            - generic [ref=e1573]:
                              ...
                              - textbox "Phone" [ref=e1576]: "0219950071"
                        - generic [ref=e1578]:
                          - listitem [ref=e1580]:
                            ...
                            - group "Name required" [ref=e1591]:
                              ...
                              - generic [ref=e1595]:
                                ...
                                - generic [ref=e1617]:
                                  ...
                                  - textbox "First Name" [ref=e1620]: Arianna
                                - generic [ref=e1624]:
                                  - generic [ref=e1625]: "*Last Name"
                                  - textbox "Last Name" [ref=e1627]: Deckow
                          - listitem [ref=e1629]:
                            - button "Undo Mobile" [ref=e1631] [cursor=pointer]:
                              - img [ref=e1633]
                            - generic [ref=e1640]:
                              - generic [ref=e1641]: Mobile
                              - textbox "Mobile" [ref=e1643]: "09785800172"
                        - generic [ref=e1645]:
                          - listitem [ref=e1647]:
                            ...
                            - generic [ref=e1659]:
                              ...
                              - textbox "Company" [ref=e1662]: Hudson - Murphy
                          - listitem [ref=e1664]:
                            - button "Undo Fax" [ref=e1666] [cursor=pointer]:
                              - img [ref=e1668]
                            - generic [ref=e1675]:
                              - generic [ref=e1676]: Fax
                              - textbox "Fax" [ref=e1678]: "0173556398"
                        - generic [ref=e1680]:
                          - listitem [ref=e1682]:
                            ...
                            - generic [ref=e1694]:
                              ...
                              - textbox "Title" [ref=e1697]: Customer Markets Strategist
                          - listitem [ref=e1699]:
                            - button "Undo Email" [ref=e1701] [cursor=pointer]:
                              - img [ref=e1703]
                            - generic [ref=e1710]:
                              - generic [ref=e1711]: Email
                              - textbox "Email" [ref=e1713]: arianna.deckow@gmail.com
                        - generic [ref=e1715]:
                          - listitem [ref=e1717]:
                            - generic [ref=e1724]:
                              - generic [ref=e1726]: Lead Source
                              - generic [ref=e1730]:
                                - combobox "Lead Source" [expanded] [active] [ref=e1731] [cursor=pointer]:
                                  - generic [ref=e1732]: "--None--"
                                - img [ref=e1736]
                                - listbox "Lead Source" [ref=e1739]:
                                  - option "--None--" [checked] [selected] [ref=e1740]:
                                    - img [ref=e1745]
                                    - generic [ref=e1748]: "--None--"
                                  - option "Web" [ref=e1749]:
                                    - generic [ref=e1750]: Web
                                  - option "Phone Inquiry" [ref=e1751]:
                                    - generic [ref=e1752]: Phone Inquiry
                                  - option "Partner Referral" [ref=e1753]:
                                    - generic [ref=e1754]: Partner Referral
                                  - option "Purchased List" [ref=e1755]:
                                    - generic [ref=e1756]: Purchased List
                                  - option "Other" [ref=e1757]:
                                    - generic [ref=e1758]: Other
                              - status
                          - listitem [ref=e1760]:
                            - button "Undo Website" [ref=e1762] [cursor=pointer]:
                              - img [ref=e1764]
                            - generic [ref=e1771]:
                              - generic [ref=e1772]: Website
                              - textbox "Website" [ref=e1774]: https://gripping-hundred.biz
                        - generic [ref=e1776]:
                          - listitem [ref=e1778]:
                            - generic [ref=e1785]:
                              - generic [ref=e1787]: Industry
                              - generic [ref=e1791]:
                                - combobox "Industry" [ref=e1792] [cursor=pointer]:
                                  - generic [ref=e1793]: "--None--"
                                - img [ref=e1797]
                              - status
                          - listitem [ref=e1801]:
                            - generic [ref=e1808]:
                              - generic [ref=e1810]: "*Lead Status"
                              - generic [ref=e1814]:
                                - combobox "Lead Status" [ref=e1815] [cursor=pointer]:
                                  - generic [ref=e1816]: Open - Not Contacted
                                - img [ref=e1820]
                              - status
                        - generic [ref=e1824]:
                          - listitem [ref=e1826]:
                            - button "Undo Annual Revenue" [ref=e1828] [cursor=pointer]:
                              - img [ref=e1830]
                            - generic [ref=e1838]:
                              - generic [ref=e1839]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e1841]: $588
                          - listitem [ref=e1843]:
                            - generic [ref=e1850]:
                              - generic [ref=e1852]: Rating
                              - generic [ref=e1856]:
                                - combobox "Rating" [ref=e1857] [cursor=pointer]:
                                  - generic [ref=e1858]: "--None--"
                                - img [ref=e1862]
                              - status
                        - listitem [ref=e1869]:
                          - button "Undo No. of Employees" [ref=e1871] [cursor=pointer]:
                            - img [ref=e1873]
                          - generic [ref=e1880]:
                            - generic [ref=e1881]: No. of Employees
                            - spinbutton "No. of Employees" [ref=e1883]: "413"
                  - generic [ref=e1885]:
                    - heading "Address Information" [level=3] [ref=e1886]:
                      - generic [ref=e1887]: Address Information
                    - list [ref=e1889]:
                      - listitem [ref=e1894]:
                        - group "Address" [ref=e1899]:
                          - generic [ref=e1900]: Address
                          - generic [ref=e1902]:
                            - generic [ref=e1906]:
                              - generic [ref=e1908]: Country
                              - generic [ref=e1912]:
                                - combobox "Country" [ref=e1915]: "--None--"
                                - img [ref=e1919]
                              - status
                            - generic [ref=e1923]:
                              - generic [ref=e1924]: Street
                              - textbox "Street" [ref=e1926]
                              - status
                            - generic [ref=e1927]:
                              - generic [ref=e1930]:
                                - generic [ref=e1931]: City
                                - textbox "City" [ref=e1933]
                              - generic [ref=e1936]:
                                - generic [ref=e1938]: State/Province
                                - generic [ref=e1942]:
                                  - combobox "State/Province" [ref=e1945]: "--None--"
                                  - img [ref=e1949]
                                - status
                            - generic [ref=e1955]:
                              - generic [ref=e1956]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e1958]
                  - generic [ref=e1961]:
                    - heading "Additional Information" [level=3] [ref=e1962]:
                      - generic [ref=e1963]: Additional Information
                    - list [ref=e1965]:
                      - generic [ref=e1966]:
                        - generic [ref=e1968]:
                          - listitem [ref=e1970]:
                            - generic [ref=e1977]:
                              - generic [ref=e1979]: Product Interest
                              - generic [ref=e1983]:
                                - combobox "Product Interest" [ref=e1984] [cursor=pointer]:
                                  - generic [ref=e1985]: "--None--"
                                - img [ref=e1989]
                              - status
                          - listitem [ref=e1993]:
                            - generic [ref=e1999]:
                              - generic [ref=e2000]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e2002]
                        - generic [ref=e2004]:
                          - listitem [ref=e2006]:
                            - generic [ref=e2012]:
                              - generic [ref=e2013]: SIC Code
                              - textbox "SIC Code" [ref=e2015]
                          - listitem [ref=e2017]:
                            - generic [ref=e2024]:
                              - generic [ref=e2026]: Primary
                              - generic [ref=e2030]:
                                - combobox "Primary" [ref=e2031] [cursor=pointer]:
                                  - generic [ref=e2032]: "--None--"
                                - img [ref=e2036]
                              - status
                        - listitem [ref=e2042]:
                          - generic [ref=e2047]:
                            - generic [ref=e2048]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e2050]
                  - generic [ref=e2053]:
                    - heading "Description Information" [level=3] [ref=e2054]:
                      - generic [ref=e2055]: Description Information
                    - list [ref=e2057]:
                      - listitem [ref=e2062]:
                        - generic [ref=e2066]:
                          - generic [ref=e2067]: Description
                          - textbox "Description" [ref=e2069]
                          - status
                - generic [ref=e2074]:
                  - generic "Cancel" [ref=e2075]:
                    - button "Cancel" [ref=e2080] [cursor=pointer]
                  - generic "Save & New" [ref=e2081]:
                    - button "Save & New" [ref=e2086] [cursor=pointer]
                  - generic "Save" [ref=e2087]:
                    - button "Save" [ref=e2092] [cursor=pointer]
          - status [ref=e2093]
  - generic:
    - status
```
