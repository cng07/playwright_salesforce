...
Call log:
  - waiting for getByRole('option', { name: 'Open - Not Contacted' })
    - locator resolved to <lightning-base-combobox-item role="option" lwc-4kb6kaqheak="" aria-checked="true" exportparts="option" aria-selected="true" lwc-7co8ha3nedg-host="" id="combobox-button-618-1-618" data-value="Open - Not Contacted" data-item-id="combobox-button-618-1" class="slds-media slds-listbox__option slds-media_center slds-media_small slds-listbox__option_plain">…</lightning-base-combobox-item>
                        ...
                        - generic [ref=e1016]:
                          ...
                          - listitem [ref=e1034]:
                            ...
                            - generic [ref=e1045]:
                              ...
                              - textbox "Phone" [ref=e1048]: "02227371503216437075"
                        - generic [ref=e1050]:
                          - listitem [ref=e1052]:
                            ...
                            - group "Name required" [ref=e1063]:
                              ...
                              - generic [ref=e1067]:
                                - generic [ref=e1071]:
                                  ...
                                  - generic [ref=e1077]:
                                    - combobox "Salutation" [ref=e1078] [cursor=pointer]:
                                      - generic [ref=e1079]: Mr.
                                    - img [ref=e1083]
                                  - status
                                - generic [ref=e1089]:
                                  - generic [ref=e1090]: First Name
                                  - textbox "First Name" [ref=e1092]: Nathan
                                - generic [ref=e1096]:
                                  - generic [ref=e1097]: "*Last Name"
                                  - textbox "Last Name" [ref=e1099]: Luettgen
                          - listitem [ref=e1101]:
                            - button "Undo Mobile" [ref=e1103] [cursor=pointer]:
                              - img [ref=e1105]
                            - generic [ref=e1112]:
                              - generic [ref=e1113]: Mobile
                              - textbox "Mobile" [ref=e1115]: "09684677846"
                        - generic [ref=e1117]:
                          - listitem [ref=e1119]:
                            - button "Undo Company" [ref=e1121] [cursor=pointer]:
                              - img [ref=e1123]
                            - generic [ref=e1131]:
                              - generic [ref=e1132]: "*Company"
                              - textbox "Company" [ref=e1134]: Steuber, Rau and Kertzmann
                          - listitem [ref=e1136]:
                            - generic [ref=e1141]:
                              - generic [ref=e1142]: Fax
                              - textbox "Fax" [ref=e1144]
                        - generic [ref=e1146]:
                          - listitem [ref=e1148]:
                            - button "Undo Title" [ref=e1150] [cursor=pointer]:
                              - img [ref=e1152]
                            - generic [ref=e1160]:
                              - generic [ref=e1161]: Title
                              - textbox "Title" [ref=e1163]: Chief Division Architect
                          - listitem [ref=e1165]:
                            - button "Undo Email" [ref=e1167] [cursor=pointer]:
                              - img [ref=e1169]
                            - generic [ref=e1176]:
                              - generic [ref=e1177]: Email
                              - textbox "Email" [ref=e1179]: nathan.luettgen@hotmail.com
                        - generic [ref=e1181]:
                          - listitem [ref=e1183]:
                            - button "Undo Lead Source" [ref=e1185] [cursor=pointer]:
                              - img [ref=e1187]
                            - generic [ref=e1196]:
                              - generic [ref=e1198]: Lead Source
                              - generic [ref=e1202]:
                                - combobox "Lead Source" [ref=e1203] [cursor=pointer]:
                                  - generic [ref=e1204]: Other
                                - img [ref=e1208]
                              - status
                          - listitem [ref=e1212]:
                            - button "Undo Website" [ref=e1214] [cursor=pointer]:
                              - img [ref=e1216]
                            - generic [ref=e1223]:
                              - generic [ref=e1224]: Website
                              - textbox "Website" [ref=e1226]: https://ignorant-partridge.info
                        - generic [ref=e1228]:
                          - listitem [ref=e1230]:
                            - button "Undo Industry" [ref=e1232] [cursor=pointer]:
                              - img [ref=e1234]
                            - generic [ref=e1243]:
                              - generic [ref=e1245]: Industry
                              - generic [ref=e1249]:
                                - combobox "Industry" [ref=e1250] [cursor=pointer]:
                                  - generic [ref=e1251]: Not For Profit
                                - img [ref=e1255]
                              - status
                          - listitem [ref=e1259]:
                            - generic [ref=e1266]:
                              - generic [ref=e1268]: "*Lead Status"
                              - generic [ref=e1272]:
                                - combobox "Lead Status" [expanded] [active] [ref=e1273] [cursor=pointer]:
                                  - generic [ref=e1274]: Open - Not Contacted
                                - img [ref=e1278]
                                - listbox "Lead Status" [ref=e1281]:
                                  - option "--None--" [ref=e1282]:
                                    - generic [ref=e1283]: "--None--"
                                  - option "Open - Not Contacted" [checked] [selected] [ref=e1284]:
                                    - img [ref=e1289]
                                    - generic [ref=e1292]: Open - Not Contacted
                                  - option "Working - Contacted" [ref=e1293]:
                                    - generic [ref=e1294]: Working - Contacted
                                  - option "Closed - Converted" [ref=e1295]:
                                    - generic [ref=e1296]: Closed - Converted
                                  - option "Closed - Not Converted" [ref=e1297]:
                                    - generic [ref=e1298]: Closed - Not Converted
                              - status
                        - generic [ref=e1300]:
                          - listitem [ref=e1302]:
                            - button "Undo Annual Revenue" [ref=e1304] [cursor=pointer]:
                              - img [ref=e1306]
                            - generic [ref=e1314]:
                              - generic [ref=e1315]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e1317]: $203
                          - listitem [ref=e1319]:
                            - generic [ref=e1326]:
                              - generic [ref=e1328]: Rating
                              - generic [ref=e1332]:
                                - combobox "Rating" [ref=e1333] [cursor=pointer]:
                                  - generic [ref=e1334]: "--None--"
                                - img [ref=e1338]
                              - status
                        - listitem [ref=e1345]:
                          - button "Undo No. of Employees" [ref=e1347] [cursor=pointer]:
                            - img [ref=e1349]
                          - generic [ref=e1356]:
                            - generic [ref=e1357]: No. of Employees
                            - spinbutton "No. of Employees" [ref=e1359]: "335"
                  - generic [ref=e1361]:
                    - heading "Address Information" [level=3] [ref=e1362]:
                      - generic [ref=e1363]: Address Information
                    - list [ref=e1365]:
                      - listitem [ref=e1370]:
                        - group "Address" [ref=e1375]:
                          - generic [ref=e1376]: Address
                          - generic [ref=e1378]:
                            - generic [ref=e1382]:
                              - generic [ref=e1384]: Country
                              - generic [ref=e1388]:
                                - combobox "Country" [ref=e1391]: "--None--"
                                - img [ref=e1395]
                              - status
                            - generic [ref=e1399]:
                              - generic [ref=e1400]: Street
                              - textbox "Street" [ref=e1402]
                              - status
                            - generic [ref=e1403]:
                              - generic [ref=e1406]:
                                - generic [ref=e1407]: City
                                - textbox "City" [ref=e1409]
                              - generic [ref=e1412]:
                                - generic [ref=e1414]: State/Province
                                - generic [ref=e1418]:
                                  - combobox "State/Province" [ref=e1421]: "--None--"
                                  - img [ref=e1425]
                                - status
                            - generic [ref=e1431]:
                              - generic [ref=e1432]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e1434]
                  - generic [ref=e1437]:
                    - heading "Additional Information" [level=3] [ref=e1438]:
                      - generic [ref=e1439]: Additional Information
                    - list [ref=e1441]:
                      - generic [ref=e1442]:
                        - generic [ref=e1444]:
                          - listitem [ref=e1446]:
                            - generic [ref=e1453]:
                              - generic [ref=e1455]: Product Interest
                              - generic [ref=e1459]:
                                - combobox "Product Interest" [ref=e1460] [cursor=pointer]:
                                  - generic [ref=e1461]: "--None--"
                                - img [ref=e1465]
                              - status
                          - listitem [ref=e1469]:
                            - generic [ref=e1475]:
                              - generic [ref=e1476]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e1478]
                        - generic [ref=e1480]:
                          - listitem [ref=e1482]:
                            - generic [ref=e1488]:
                              - generic [ref=e1489]: SIC Code
                              - textbox "SIC Code" [ref=e1491]
                          - listitem [ref=e1493]:
                            - generic [ref=e1500]:
                              - generic [ref=e1502]: Primary
                              - generic [ref=e1506]:
                                - combobox "Primary" [ref=e1507] [cursor=pointer]:
                                  - generic [ref=e1508]: "--None--"
                                - img [ref=e1512]
                              - status
                        - listitem [ref=e1518]:
                          - generic [ref=e1523]:
                            - generic [ref=e1524]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e1526]
                  - generic [ref=e1529]:
                    - heading "Description Information" [level=3] [ref=e1530]:
                      - generic [ref=e1531]: Description Information
                    - list [ref=e1533]:
                      - listitem [ref=e1538]:
                        - generic [ref=e1542]:
                          - generic [ref=e1543]: Description
                          - textbox "Description" [ref=e1545]
                          - status
                - generic [ref=e1550]:
                  - generic "Cancel" [ref=e1551]:
                    - button "Cancel" [ref=e1556] [cursor=pointer]
                  - generic "Save & New" [ref=e1557]:
                    - button "Save & New" [ref=e1562] [cursor=pointer]
                  - generic "Save" [ref=e1563]:
                    - button "Save" [ref=e1568] [cursor=pointer]
          - status [ref=e1569]
  - generic:
    - status
```
