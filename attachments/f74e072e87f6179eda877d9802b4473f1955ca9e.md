...
Call log:
  ...
  - waiting for getByText('was created.')
    3 × locator resolved to <span data-aura-rendered-by="1345:0" data-aura-class="forceActionsText" class="toastMessage slds-text-heading--small forceActionsText">…</span>
...
- main:
  - heading "Lead Mr. Edward Deckow" [level=1]
  - button "New Case"
  - button "New Note"
  - button "Submit for Approval"
  - button "Show more actions"
  - paragraph: Title
  - paragraph: Legacy Division Assistant
  - paragraph: Company
  - paragraph: Rowe - O'Connell
  - button "Phone (2)":
    - paragraph: Phone (2)
  - list:
    - paragraph:
      - link "(023) 001-2108":
        - /url: tel:0230012108
  - paragraph: Email
  - paragraph: edward.deckow@hotmail.com
