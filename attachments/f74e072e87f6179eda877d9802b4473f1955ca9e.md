...
Call log:
  ...
  - waiting for getByText('was created.')
    3 × locator resolved to <span data-aura-rendered-by="1311:0" data-aura-class="forceActionsText" class="toastMessage slds-text-heading--small forceActionsText">…</span>
...
- main:
  - heading "Lead Mr. Myrtle Larson" [level=1]
  - button "New Case"
  - button "New Note"
  - button "Submit for Approval"
  - button "Show more actions"
  - paragraph: Title
  - paragraph: Principal Communications Consultant
  - paragraph: Company
  - paragraph: Bednar - Russel
  - button "Phone (2)":
    - paragraph: Phone (2)
  - list:
    - paragraph:
      - link "(028) 582-9875":
        - /url: tel:0285829875
  - paragraph: Email
  - paragraph: myrtle.larson47@gmail.com
