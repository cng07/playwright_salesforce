...
Call log:
  - waiting for getByRole('combobox', { name: 'Salutation' })
    - locator resolved to <button type="button" role="combobox" name="salutation" lwc-4kb6kaqheak="" part="input-button" aria-expanded="false" data-value="--None--" aria-disabled="false" aria-required="false" aria-haspopup="listbox" aria-label="Salutation" id="combobox-button-698" aria-describedby="help-text-697" aria-controls="dropdown-element-698" class="slds-combobox__input slds-input_faux fix-slds-input_faux slds-combobox__input-value">…</button>
                        ...
                        - generic [ref=e1412]:
                          ...
                          - listitem [ref=e1430]:
                            ...
                            - generic [ref=e1441]:
                              ...
                              - textbox "Phone" [active] [ref=e1444]: "0266508283"
                        - generic [ref=e1446]:
                          - listitem [ref=e1448]:
                            ...
                            - group "Name required" [ref=e1459]:
                              ...
                              - generic [ref=e1463]:
                                ...
                                - generic [ref=e1485]:
                                  ...
                                  - textbox "First Name" [ref=e1488]: Nikita
                                - generic [ref=e1492]:
                                  - generic [ref=e1493]: "*Last Name"
                                  - textbox "Last Name" [ref=e1495]: Considine
                          - listitem [ref=e1497]:
                            - button "Undo Mobile" [ref=e1499] [cursor=pointer]:
                              - img [ref=e1501]
                            - generic [ref=e1508]:
                              - generic [ref=e1509]: Mobile
                              - textbox "Mobile" [ref=e1511]: "09871357873"
                        - generic [ref=e1513]:
                          - listitem [ref=e1515]:
                            ...
                            - generic [ref=e1527]:
                              ...
                              - textbox "Company" [ref=e1530]: Carroll Group
                          - listitem [ref=e1532]:
                            - button "Undo Fax" [ref=e1534] [cursor=pointer]:
                              - img [ref=e1536]
                            - generic [ref=e1543]:
                              - generic [ref=e1544]: Fax
                              - textbox "Fax" [ref=e1546]: "9707736360"
                        - generic [ref=e1548]:
                          - listitem [ref=e1550]:
                            ...
                            - generic [ref=e1562]:
                              ...
                              - textbox "Title" [ref=e1565]: Customer Tactics Liaison
                          - listitem [ref=e1567]:
                            - button "Undo Email" [ref=e1569] [cursor=pointer]:
                              - img [ref=e1571]
                            - generic [ref=e1578]:
                              - generic [ref=e1579]: Email
                              - textbox "Email" [ref=e1581]: nikita_considine24@hotmail.com
                        - generic [ref=e1583]:
                          - listitem [ref=e1585]:
                            - generic [ref=e1592]:
                              ...
                              - status
                          - listitem [ref=e1608]:
                            - button "Undo Website" [ref=e1610] [cursor=pointer]:
                              - img [ref=e1612]
                            - generic [ref=e1619]:
                              - generic [ref=e1620]: Website
                              - textbox "Website" [ref=e1622]: https://yellowish-platypus.name
                        - generic [ref=e1624]:
                          - listitem [ref=e1626]:
                            - generic [ref=e1633]:
                              - generic [ref=e1635]: Industry
                              - generic [ref=e1639]:
                                - combobox "Industry" [ref=e1640] [cursor=pointer]:
                                  - generic [ref=e1641]: "--None--"
                                - img [ref=e1645]
                              - status
                          - listitem [ref=e1649]:
                            - generic [ref=e1656]:
                              - generic [ref=e1658]: "*Lead Status"
                              - generic [ref=e1662]:
                                - combobox "Lead Status" [ref=e1663] [cursor=pointer]:
                                  - generic [ref=e1664]: Open - Not Contacted
                                - img [ref=e1668]
                              - status
                        - generic [ref=e1672]:
                          - listitem [ref=e1674]:
                            - button "Undo Annual Revenue" [ref=e1676] [cursor=pointer]:
                              - img [ref=e1678]
                            - generic [ref=e1686]:
                              - generic [ref=e1687]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e1689]: $834
                          - listitem [ref=e1691]:
                            - generic [ref=e1698]:
                              - generic [ref=e1700]: Rating
                              - generic [ref=e1704]:
                                - combobox "Rating" [ref=e1705] [cursor=pointer]:
                                  - generic [ref=e1706]: "--None--"
                                - img [ref=e1710]
                              - status
                        - listitem [ref=e1717]:
                          - button "Undo No. of Employees" [ref=e1719] [cursor=pointer]:
                            - img [ref=e1721]
                          - generic [ref=e1728]:
                            - generic [ref=e1729]: No. of Employees
                            - spinbutton "No. of Employees" [ref=e1731]: "986"
                  - generic [ref=e1733]:
                    - heading "Address Information" [level=3] [ref=e1734]:
                      - generic [ref=e1735]: Address Information
                    - list [ref=e1737]:
                      - listitem [ref=e1742]:
                        - group "Address" [ref=e1747]:
                          - generic [ref=e1748]: Address
                          - generic [ref=e1750]:
                            - generic [ref=e1754]:
                              - generic [ref=e1756]: Country
                              - generic [ref=e1760]:
                                - combobox "Country" [ref=e1763]: "--None--"
                                - img [ref=e1767]
                              - status
                            - generic [ref=e1771]:
                              - generic [ref=e1772]: Street
                              - textbox "Street" [ref=e1774]
                              - status
                            - generic [ref=e1775]:
                              - generic [ref=e1778]:
                                - generic [ref=e1779]: City
                                - textbox "City" [ref=e1781]
                              - generic [ref=e1784]:
                                - generic [ref=e1786]: State/Province
                                - generic [ref=e1790]:
                                  - combobox "State/Province" [ref=e1793]: "--None--"
                                  - img [ref=e1797]
                                - status
                            - generic [ref=e1803]:
                              - generic [ref=e1804]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e1806]
                  - generic [ref=e1809]:
                    - heading "Additional Information" [level=3] [ref=e1810]:
                      - generic [ref=e1811]: Additional Information
                    - list [ref=e1813]:
                      - generic [ref=e1814]:
                        - generic [ref=e1816]:
                          - listitem [ref=e1818]:
                            - generic [ref=e1825]:
                              - generic [ref=e1827]: Product Interest
                              - generic [ref=e1831]:
                                - combobox "Product Interest" [ref=e1832] [cursor=pointer]:
                                  - generic [ref=e1833]: "--None--"
                                - img [ref=e1837]
                              - status
                          - listitem [ref=e1841]:
                            - generic [ref=e1847]:
                              - generic [ref=e1848]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e1850]
                        - generic [ref=e1852]:
                          - listitem [ref=e1854]:
                            - generic [ref=e1860]:
                              - generic [ref=e1861]: SIC Code
                              - textbox "SIC Code" [ref=e1863]
                          - listitem [ref=e1865]:
                            - generic [ref=e1872]:
                              - generic [ref=e1874]: Primary
                              - generic [ref=e1878]:
                                - combobox "Primary" [ref=e1879] [cursor=pointer]:
                                  - generic [ref=e1880]: "--None--"
                                - img [ref=e1884]
                              - status
                        - listitem [ref=e1890]:
                          - generic [ref=e1895]:
                            - generic [ref=e1896]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e1898]
                  - generic [ref=e1901]:
                    - heading "Description Information" [level=3] [ref=e1902]:
                      - generic [ref=e1903]: Description Information
                    - list [ref=e1905]:
                      - listitem [ref=e1910]:
                        - generic [ref=e1914]:
                          - generic [ref=e1915]: Description
                          - textbox "Description" [ref=e1917]
                          - status
                - generic [ref=e1922]:
                  - generic "Cancel" [ref=e1923]:
                    - button "Cancel" [ref=e1928] [cursor=pointer]
                  - generic "Save & New" [ref=e1929]:
                    - button "Save & New" [ref=e1934] [cursor=pointer]
                  - generic "Save" [ref=e1935]:
                    - button "Save" [ref=e1940] [cursor=pointer]
          - status [ref=e1941]
  - generic:
    - status
```
