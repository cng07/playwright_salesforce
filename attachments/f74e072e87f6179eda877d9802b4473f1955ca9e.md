...
- main:
  ...
  - group "Key Performance Indicators":
    ...
    - button "Upcoming" [disabled]:
      ...
      - status
    - button "Help"
  - status: 17 items • Filtered by Created Date, Me, Total Leads
  - group:
  ...
  - grid:
    - rowgroup:
      - row "Row Number Choose a Row Select 17 items Name Important Title Company Lead Status Lead Source Last Activity Actions Action":
        - columnheader "Row Number"
        - gridcell "Choose a Row Select 17 items":
          - text: Choose a Row
          - checkbox "Select 17 items"
          - text: Select 17 items
        - columnheader "Name":
          - 'button "Sort by: Name"'
          - text: "Sorted: None"
...
- contentinfo "Utility Bar":
  - list:
    - listitem:
      - button "To Do List"
- status: Success notification..Lead "Mrs. Gabrielle Turner" was saved. Press Command + F6 to navigate to the next toast notification or focusable region.
```
