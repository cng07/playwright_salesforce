...
Call log:
  - waiting for getByRole('combobox', { name: 'Salutation' })
    - locator resolved to <button type="button" role="combobox" name="salutation" lwc-4kb6kaqheak="" part="input-button" aria-expanded="false" data-value="--None--" aria-disabled="false" aria-required="false" aria-haspopup="listbox" aria-label="Salutation" id="combobox-button-786" aria-describedby="help-text-785" aria-controls="dropdown-element-786" class="slds-combobox__input slds-input_faux fix-slds-input_faux slds-combobox__input-value">…</button>
            ...
            - generic [ref=e1659]:
              ...
              - generic [ref=e1662]:
                - generic [ref=e1667]:
                        ...
                        - generic [ref=e1676]:
                          ...
                          - listitem [ref=e1694]:
                            ...
                            - generic [ref=e1705]:
                              ...
                              - textbox "Phone" [ref=e1708]: "0258815513"
                        - generic [ref=e1710]:
                          - listitem [ref=e1712]:
                                ...
                                - generic [ref=e1731]:
                                  ...
                                  - generic [ref=e1737]:
                                    - combobox "Salutation" [ref=e1738] [cursor=pointer]:
                                      - generic [ref=e1739]: "--None--"
                                    - img [ref=e1743]
                                  - status
                                - generic [ref=e1749]:
                                  - generic [ref=e1750]: First Name
                                  - textbox "First Name" [ref=e1752]: Jack
                                - generic [ref=e1756]:
                                  - generic [ref=e1757]: "*Last Name"
                                  - textbox "Last Name" [ref=e1759]: Breitenberg
                          - listitem [ref=e1761]:
                            - button "Undo Mobile" [ref=e1763] [cursor=pointer]:
                              - img [ref=e1765]
                            - generic [ref=e1772]:
                              - generic [ref=e1773]: Mobile
                              - textbox "Mobile" [ref=e1775]: "09582839492"
                        - generic [ref=e1777]:
                          - listitem [ref=e1779]:
                            ...
                            - generic [ref=e1791]:
                              ...
                              - textbox "Company" [ref=e1794]: Dietrich Group
                          - listitem [ref=e1796]:
                            - button "Undo Fax" [ref=e1798] [cursor=pointer]:
                              - img [ref=e1800]
                            - generic [ref=e1807]:
                              - generic [ref=e1808]: Fax
                              - textbox "Fax" [ref=e1810]: "6793596246"
                        - generic [ref=e1812]:
                          - listitem [ref=e1814]:
                            ...
                            - generic [ref=e1826]:
                              ...
                              - textbox "Title" [ref=e1829]: Human Usability Producer
                          - listitem [ref=e1831]:
                            - button "Undo Email" [ref=e1833] [cursor=pointer]:
                              - img [ref=e1835]
                            - generic [ref=e1842]:
                              - generic [ref=e1843]: Email
                              - textbox "Email" [ref=e1845]: jack.breitenberg9@yahoo.com
                        - generic [ref=e1847]:
                          - listitem [ref=e1849]:
                            - generic [ref=e1856]:
                              - generic [ref=e1858]: Lead Source
                              - generic [ref=e1862]:
                                - combobox "Lead Source" [ref=e1863] [cursor=pointer]:
                                  - generic [ref=e1864]: "--None--"
                                - img [ref=e1868]
                              - status
                          - listitem [ref=e1872]:
                            - button "Undo Website" [ref=e1874] [cursor=pointer]:
                              - img [ref=e1876]
                            - generic [ref=e1883]:
                              - generic [ref=e1884]: Website
                              - textbox "Website" [ref=e1886]: https://hard-to-find-premeditation.net
                        - generic [ref=e1888]:
                          - listitem [ref=e1890]:
                            - generic [ref=e1897]:
                              - generic [ref=e1899]: Industry
                              - generic [ref=e1903]:
                                - combobox "Industry" [ref=e1904] [cursor=pointer]:
                                  - generic [ref=e1905]: "--None--"
                                - img [ref=e1909]
                              - status
                          - listitem [ref=e1913]:
                            - generic [ref=e1920]:
                              ...
                              - generic [ref=e1926]:
                                - combobox "Lead Status" [ref=e1927] [cursor=pointer]:
                                  - generic [ref=e1928]: Open - Not Contacted
                                - img [ref=e1932]
                              - status
                        - generic [ref=e1936]:
                          - listitem [ref=e1938]:
                            - button "Undo Annual Revenue" [ref=e1940] [cursor=pointer]:
                              - img [ref=e1942]
                            - generic [ref=e1950]:
                              - generic [ref=e1951]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e1953]: $781
                          - listitem [ref=e1955]:
                            - generic [ref=e1962]:
                              - generic [ref=e1964]: Rating
                              - generic [ref=e1968]:
                                - combobox "Rating" [ref=e1969] [cursor=pointer]:
                                  - generic [ref=e1970]: "--None--"
                                - img [ref=e1974]
                              - status
                        - listitem [ref=e1981]:
                          - button "Undo No. of Employees" [ref=e1983] [cursor=pointer]:
                            - img [ref=e1985]
                          - generic [ref=e1992]:
                            - generic [ref=e1993]: No. of Employees
                            - spinbutton "No. of Employees" [active] [ref=e1995]: "984"
                  - generic [ref=e1997]:
                    - heading "Address Information" [level=3] [ref=e1998]:
                      - generic [ref=e1999]: Address Information
                    - list [ref=e2001]:
                      - listitem [ref=e2006]:
                        - group "Address" [ref=e2011]:
                          - generic [ref=e2012]: Address
                          - generic [ref=e2014]:
                            - generic [ref=e2018]:
                              - generic [ref=e2020]: Country
                              - generic [ref=e2024]:
                                - combobox "Country" [ref=e2027]: "--None--"
                                - img [ref=e2031]
                              - status
                            - generic [ref=e2035]:
                              - generic [ref=e2036]: Street
                              - textbox "Street" [ref=e2038]
                              - status
                            - generic [ref=e2039]:
                              - generic [ref=e2042]:
                                - generic [ref=e2043]: City
                                - textbox "City" [ref=e2045]
                              - generic [ref=e2048]:
                                - generic [ref=e2050]: State/Province
                                - generic [ref=e2054]:
                                  - combobox "State/Province" [ref=e2057]: "--None--"
                                  - img [ref=e2061]
                                - status
                            - generic [ref=e2067]:
                  ...
                  - generic [ref=e2073]:
                    - heading "Additional Information" [level=3] [ref=e2074]:
                      - generic [ref=e2075]: Additional Information
                    - list [ref=e2077]:
                      - generic [ref=e2078]:
                        - generic [ref=e2080]:
                          - listitem [ref=e2082]:
                            - generic [ref=e2089]:
                              - generic [ref=e2091]: Product Interest
                              - generic [ref=e2095]:
                                - combobox "Product Interest" [ref=e2096] [cursor=pointer]:
                                  - generic [ref=e2097]: "--None--"
                                - img [ref=e2101]
                              - status
                          - listitem [ref=e2105]:
                            - generic [ref=e2111]:
                        ...
                        - generic [ref=e2116]:
                          - listitem [ref=e2118]:
                            - generic [ref=e2124]:
                              - generic [ref=e2125]: SIC Code
                              - textbox "SIC Code" [ref=e2127]
                          - listitem [ref=e2129]:
                            - generic [ref=e2136]:
                              - generic [ref=e2138]: Primary
                              - generic [ref=e2142]:
                                - combobox "Primary" [ref=e2143] [cursor=pointer]:
                                  - generic [ref=e2144]: "--None--"
                                - img [ref=e2148]
                              - status
                        - listitem [ref=e2154]:
                          - generic [ref=e2159]:
                            - generic [ref=e2160]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e2162]
                  - generic [ref=e2165]:
                    - heading "Description Information" [level=3] [ref=e2166]:
                      - generic [ref=e2167]: Description Information
                    - list [ref=e2169]:
                      - listitem [ref=e2174]:
                        - generic [ref=e2178]:
                          - generic [ref=e2179]: Description
                          - textbox "Description" [ref=e2181]
                          - status
                - generic [ref=e2186]:
                  - generic "Cancel" [ref=e2187]:
                    - button "Cancel" [ref=e2192] [cursor=pointer]
                  - generic "Save & New" [ref=e2193]:
                    - button "Save & New" [ref=e2198] [cursor=pointer]
                  - generic "Save" [ref=e2199]:
                    - button "Save" [ref=e2204] [cursor=pointer]
          - status [ref=e2205]
  - generic:
    - status
```
