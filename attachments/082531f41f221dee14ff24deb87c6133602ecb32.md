...
Call log:
  - waiting for getByRole('combobox', { name: 'Salutation' })
    - locator resolved to <button type="button" role="combobox" name="salutation" lwc-4kb6kaqheak="" part="input-button" aria-expanded="false" data-value="--None--" aria-disabled="false" aria-required="false" aria-haspopup="listbox" aria-label="Salutation" id="combobox-button-769" aria-describedby="help-text-768" aria-controls="dropdown-element-769" class="slds-combobox__input slds-input_faux fix-slds-input_faux slds-combobox__input-value">…</button>
                    ...
                    - list [ref=e1805]:
                      - generic [ref=e1806]:
                        - generic [ref=e1808]:
                          ...
                          - listitem [ref=e1826]:
                            - button "Undo Phone" [active] [ref=e1828] [cursor=pointer]:
                              - generic [ref=e1829]:
                                - img
                            - generic [ref=e1834]:
                              - generic [ref=e1835]: Phone
                              - textbox "Phone" [ref=e1837]: "0266590052"
                        - generic [ref=e1839]:
                          - listitem [ref=e1841]:
                            - button "Undo Name" [ref=e1843] [cursor=pointer]:
                              - img [ref=e1845]
                            - group "Name required" [ref=e1852]:
                              - generic [ref=e1853]:
                                - text: "*Name"
                                - generic "required" [ref=e1854]
                              - generic [ref=e1856]:
                                - generic [ref=e1860]:
                                  - generic [ref=e1862]: Salutation
                                  - generic [ref=e1866]:
                                    - combobox "Salutation" [ref=e1867] [cursor=pointer]:
                                      - generic [ref=e1868]: "--None--"
                                    - img [ref=e1872]
                                  - status
                                - generic [ref=e1878]:
                                  - generic [ref=e1879]: First Name
                                  - textbox "First Name" [ref=e1881]: Jewell
                                - generic [ref=e1885]:
                                  - generic [ref=e1886]: "*Last Name"
                                  - textbox "Last Name" [ref=e1888]: Reilly
                          - listitem [ref=e1890]:
                            - button "Undo Mobile" [ref=e1892] [cursor=pointer]:
                              - img [ref=e1894]
                            - generic [ref=e1901]:
                              - generic [ref=e1902]: Mobile
                              - textbox "Mobile" [ref=e1904]: "09433853345"
                        - generic [ref=e1906]:
                          - listitem [ref=e1908]:
                            - button "Undo Company" [ref=e1910] [cursor=pointer]:
                              - img [ref=e1912]
                            - generic [ref=e1920]:
                              - generic [ref=e1921]: "*Company"
                              - textbox "Company" [ref=e1923]: Fay-Aufderhar, Considine and Hilpert
                          - listitem [ref=e1925]:
                            - button "Undo Fax" [ref=e1927] [cursor=pointer]:
                              - img [ref=e1929]
                            - generic [ref=e1936]:
                              - generic [ref=e1937]: Fax
                              - textbox "Fax" [ref=e1939]: "7503494688"
                        - generic [ref=e1941]:
                          - listitem [ref=e1943]:
                            - button "Undo Title" [ref=e1945] [cursor=pointer]:
                              - img [ref=e1947]
                            - generic [ref=e1955]:
                              - generic [ref=e1956]: Title
                              - textbox "Title" [ref=e1958]: Future Optimization Consultant
                          - listitem [ref=e1960]:
                            - button "Undo Email" [ref=e1962] [cursor=pointer]:
                              - img [ref=e1964]
                            - generic [ref=e1971]:
                              - generic [ref=e1972]: Email
                              - textbox "Email" [ref=e1974]: jewell.reilly@yahoo.com
                        - generic [ref=e1976]:
                          - listitem [ref=e1978]:
                            - generic [ref=e1985]:
                              - generic [ref=e1987]: Lead Source
                              - generic [ref=e1991]:
                                - combobox "Lead Source" [ref=e1992] [cursor=pointer]:
                                  - generic [ref=e1993]: "--None--"
                                - img [ref=e1997]
                              - status
                          - listitem [ref=e2001]:
                            - button "Undo Website" [ref=e2003] [cursor=pointer]:
                              - img [ref=e2005]
                            - generic [ref=e2012]:
                              - generic [ref=e2013]: Website
                              - textbox "Website" [ref=e2015]: https://frugal-barracks.com/
                        - generic [ref=e2017]:
                          - listitem [ref=e2019]:
                            - generic [ref=e2026]:
                              - generic [ref=e2028]: Industry
                              - generic [ref=e2032]:
                                - combobox "Industry" [ref=e2033] [cursor=pointer]:
                                  - generic [ref=e2034]: "--None--"
                                - img [ref=e2038]
                              - status
                          - listitem [ref=e2042]:
                            - generic [ref=e2049]:
                              - generic [ref=e2051]: "*Lead Status"
                              - generic [ref=e2055]:
                                - combobox "Lead Status" [ref=e2056] [cursor=pointer]:
                                  - generic [ref=e2057]: Open - Not Contacted
                                - img [ref=e2061]
                              - status
                        - generic [ref=e2065]:
                          - listitem [ref=e2067]:
                            - button "Undo Annual Revenue" [ref=e2069] [cursor=pointer]:
                              - img [ref=e2071]
                            - generic [ref=e2079]:
                              - generic [ref=e2080]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e2082]: $172
                          - listitem [ref=e2084]:
                            - generic [ref=e2091]:
                              - generic [ref=e2093]: Rating
                              - generic [ref=e2097]:
                                - combobox "Rating" [ref=e2098] [cursor=pointer]:
                                  - generic [ref=e2099]: "--None--"
                                - img [ref=e2103]
                              - status
                        - listitem [ref=e2110]:
                          - button "Undo No. of Employees" [ref=e2112] [cursor=pointer]:
                            - img [ref=e2114]
                          - generic [ref=e2121]:
                            - generic [ref=e2122]: No. of Employees
                            - spinbutton "No. of Employees" [ref=e2124]: "816"
                  - generic [ref=e2126]:
                    - heading "Address Information" [level=3] [ref=e2127]:
                      - generic [ref=e2128]: Address Information
                    - list [ref=e2130]:
                      - listitem [ref=e2135]:
                        - group "Address" [ref=e2140]:
                          - generic [ref=e2141]: Address
                          - generic [ref=e2143]:
                            - generic [ref=e2147]:
                              - generic [ref=e2149]: Country
                              - generic [ref=e2153]:
                                - combobox "Country" [ref=e2156]: "--None--"
                                - img [ref=e2160]
                              - status
                            - generic [ref=e2164]:
                              - generic [ref=e2165]: Street
                              - textbox "Street" [ref=e2167]
                              - status
                            - generic [ref=e2168]:
                              - generic [ref=e2171]:
                                - generic [ref=e2172]: City
                                - textbox "City" [ref=e2174]
                              - generic [ref=e2177]:
                                - generic [ref=e2179]: State/Province
                                - generic [ref=e2183]:
                                  - combobox "State/Province" [ref=e2186]: "--None--"
                                  - img [ref=e2190]
                                - status
                            - generic [ref=e2196]:
                              - generic [ref=e2197]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e2199]
                  - generic [ref=e2202]:
                    - heading "Additional Information" [level=3] [ref=e2203]:
                      - generic [ref=e2204]: Additional Information
                    - list [ref=e2206]:
                      - generic [ref=e2207]:
                        - generic [ref=e2209]:
                          - listitem [ref=e2211]:
                            - generic [ref=e2218]:
                              - generic [ref=e2220]: Product Interest
                              - generic [ref=e2224]:
                                - combobox "Product Interest" [ref=e2225] [cursor=pointer]:
                                  - generic [ref=e2226]: "--None--"
                                - img [ref=e2230]
                              - status
                          - listitem [ref=e2234]:
                            - generic [ref=e2240]:
                              - generic [ref=e2241]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e2243]
                        - generic [ref=e2245]:
                          - listitem [ref=e2247]:
                            - generic [ref=e2253]:
                              - generic [ref=e2254]: SIC Code
                              - textbox "SIC Code" [ref=e2256]
                          - listitem [ref=e2258]:
                            - generic [ref=e2265]:
                              - generic [ref=e2267]: Primary
                              - generic [ref=e2271]:
                                - combobox "Primary" [ref=e2272] [cursor=pointer]:
                                  - generic [ref=e2273]: "--None--"
                                - img [ref=e2277]
                              - status
                        - listitem [ref=e2283]:
                          - generic [ref=e2288]:
                            - generic [ref=e2289]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e2291]
                  - generic [ref=e2294]:
                    - heading "Description Information" [level=3] [ref=e2295]:
                      - generic [ref=e2296]: Description Information
                    - list [ref=e2298]:
                      - listitem [ref=e2303]:
                        - generic [ref=e2307]:
                          - generic [ref=e2308]: Description
                          - textbox "Description" [ref=e2310]
                          - status
                - generic [ref=e2315]:
                  - generic "Cancel" [ref=e2316]:
                    - button "Cancel" [ref=e2321] [cursor=pointer]
                  - generic "Save & New" [ref=e2322]:
                    - button "Save & New" [ref=e2327] [cursor=pointer]
                  - generic "Save" [ref=e2328]:
                    - button "Save" [ref=e2333] [cursor=pointer]
          - status [ref=e2334]
  - generic:
    - status
```
