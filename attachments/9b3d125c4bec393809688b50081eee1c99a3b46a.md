...
- main:
  ...
  - group "Key Performance Indicators":
    - button "Total Leads 4" [pressed]:
      - paragraph: Total Leads
      - paragraph: "4"
    - button "No Activity 4":
    ...
    - button "Upcoming 0":
      ...
      - paragraph: "0"
    - button "Help"
  - status: 4 items • Filtered by Created Date, Me, Total Leads
  - group:
  ...
  - grid:
    - rowgroup:
      - row "Row Number Choose a Row Select 4 items Name Important Title Company Lead Status Lead Source Last Activity Actions Action":
