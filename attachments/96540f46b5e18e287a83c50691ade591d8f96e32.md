...
Call log:
  - waiting for getByRole('option', { name: 'Purchased List' })
    - locator resolved to <lightning-base-combobox-item role="option" lwc-4kb6kaqheak="" exportparts="option" aria-checked="false" aria-selected="false" lwc-7co8ha3nedg-host="" data-value="Purchased List" id="combobox-button-598-4-598" data-item-id="combobox-button-598-4" class="slds-media slds-listbox__option slds-media_center slds-media_small slds-listbox__option_plain">…</lightning-base-combobox-item>
                        ...
                        - generic [ref=e1016]:
                          ...
                          - listitem [ref=e1034]:
                            ...
                            - generic [ref=e1045]:
                              ...
                              - textbox "Phone" [ref=e1048]: "0285386237"
                        - generic [ref=e1050]:
                          - listitem [ref=e1052]:
                                ...
                                - generic [ref=e1071]:
                                  ...
                                  - generic [ref=e1077]:
                                    - combobox "Salutation" [ref=e1078] [cursor=pointer]:
                                      - generic [ref=e1079]: Prof.
                                    - img [ref=e1083]
                                  - status
                                - generic [ref=e1089]:
                                  - generic [ref=e1090]: First Name
                                  - textbox "First Name" [ref=e1092]: Mackenzie
                                - generic [ref=e1096]:
                                  - generic [ref=e1097]: "*Last Name"
                                  - textbox "Last Name" [ref=e1099]: Gusikowski
                          - listitem [ref=e1101]:
                            - button "Undo Mobile" [ref=e1103] [cursor=pointer]:
                              - img [ref=e1105]
                            - generic [ref=e1112]:
                              - generic [ref=e1113]: Mobile
                              - textbox "Mobile" [ref=e1115]: "09832968267"
                        - generic [ref=e1117]:
                          - listitem [ref=e1119]:
                            ...
                            - generic [ref=e1131]:
                              ...
                              - textbox "Company" [ref=e1134]: Erdman - Turcotte-Fahey
                          - listitem [ref=e1136]:
                            - button "Undo Fax" [ref=e1138] [cursor=pointer]:
                              - img [ref=e1140]
                            - generic [ref=e1147]:
                              - generic [ref=e1148]: Fax
                              - textbox "Fax" [ref=e1150]: "3051490626"
                        - generic [ref=e1152]:
                          - listitem [ref=e1154]:
                            - button "Undo Title" [ref=e1156] [cursor=pointer]:
                              - img [ref=e1158]
                            - generic [ref=e1166]:
                              - generic [ref=e1167]: Title
                              - textbox "Title" [ref=e1169]: Legacy Applications Planner
                          - listitem [ref=e1171]:
                            - button "Undo Email" [ref=e1173] [cursor=pointer]:
                              - img [ref=e1175]
                            - generic [ref=e1182]:
                              - generic [ref=e1183]: Email
                              - textbox "Email" [ref=e1185]: mackenzie.gusikowski67@yahoo.com
                        - generic [ref=e1187]:
                          - listitem [ref=e1189]:
                            - generic [ref=e1196]:
                              - generic [ref=e1198]: Lead Source
                              - generic [ref=e1202]:
                                - combobox "Lead Source" [expanded] [active] [ref=e1203] [cursor=pointer]:
                                  - generic [ref=e1204]: "--None--"
                                - img [ref=e1208]
                                - listbox "Lead Source" [ref=e1211]:
                                  - option "--None--" [checked] [selected] [ref=e1212]:
                                    - img [ref=e1217]
                                    - generic [ref=e1220]: "--None--"
                                  - option "Web" [ref=e1221]:
                                    - generic [ref=e1222]: Web
                                  - option "Phone Inquiry" [ref=e1223]:
                                    - generic [ref=e1224]: Phone Inquiry
                                  - option "Partner Referral" [ref=e1225]:
                                    - generic [ref=e1226]: Partner Referral
                                  - option "Purchased List" [ref=e1227]:
                                    - generic [ref=e1228]: Purchased List
                                  - option "Other" [ref=e1229]:
                                    - generic [ref=e1230]: Other
                              - status
                          - listitem [ref=e1232]:
                            - button "Undo Website" [ref=e1234] [cursor=pointer]:
                              - img [ref=e1236]
                            - generic [ref=e1243]:
                              - generic [ref=e1244]: Website
                              - textbox "Website" [ref=e1246]: https://candid-babushka.com
                        - generic [ref=e1248]:
                          - listitem [ref=e1250]:
                            - generic [ref=e1257]:
                              - generic [ref=e1259]: Industry
                              - generic [ref=e1263]:
                                - combobox "Industry" [ref=e1264] [cursor=pointer]:
                                  - generic [ref=e1265]: "--None--"
                                - img [ref=e1269]
                              - status
                          - listitem [ref=e1273]:
                            - generic [ref=e1280]:
                              - generic [ref=e1282]: "*Lead Status"
                              - generic [ref=e1286]:
                                - combobox "Lead Status" [ref=e1287] [cursor=pointer]:
                                  - generic [ref=e1288]: Open - Not Contacted
                                - img [ref=e1292]
                              - status
                        - generic [ref=e1296]:
                          - listitem [ref=e1298]:
                            - button "Undo Annual Revenue" [ref=e1300] [cursor=pointer]:
                              - img [ref=e1302]
                            - generic [ref=e1310]:
                              - generic [ref=e1311]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e1313]: $592
                          - listitem [ref=e1315]:
                            - generic [ref=e1322]:
                              - generic [ref=e1324]: Rating
                              - generic [ref=e1328]:
                                - combobox "Rating" [ref=e1329] [cursor=pointer]:
                                  - generic [ref=e1330]: "--None--"
                                - img [ref=e1334]
                              - status
                        - listitem [ref=e1341]:
                          - button "Undo No. of Employees" [ref=e1343] [cursor=pointer]:
                            - img [ref=e1345]
                          - generic [ref=e1352]:
                            - generic [ref=e1353]: No. of Employees
                            - spinbutton "No. of Employees" [ref=e1355]: "164"
                  - generic [ref=e1357]:
                    - heading "Address Information" [level=3] [ref=e1358]:
                      - generic [ref=e1359]: Address Information
                    - list [ref=e1361]:
                      - listitem [ref=e1366]:
                        - group "Address" [ref=e1371]:
                          - generic [ref=e1372]: Address
                          - generic [ref=e1374]:
                            - generic [ref=e1378]:
                              - generic [ref=e1380]: Country
                              - generic [ref=e1384]:
                                - combobox "Country" [ref=e1387]: "--None--"
                                - img [ref=e1391]
                              - status
                            - generic [ref=e1395]:
                              - generic [ref=e1396]: Street
                              - textbox "Street" [ref=e1398]
                              - status
                            - generic [ref=e1399]:
                              - generic [ref=e1402]:
                                - generic [ref=e1403]: City
                                - textbox "City" [ref=e1405]
                              - generic [ref=e1408]:
                                - generic [ref=e1410]: State/Province
                                - generic [ref=e1414]:
                                  - combobox "State/Province" [ref=e1417]: "--None--"
                                  - img [ref=e1421]
                                - status
                            - generic [ref=e1427]:
                              - generic [ref=e1428]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e1430]
                  - generic [ref=e1433]:
                    - heading "Additional Information" [level=3] [ref=e1434]:
                      - generic [ref=e1435]: Additional Information
                    - list [ref=e1437]:
                      - generic [ref=e1438]:
                        - generic [ref=e1440]:
                          - listitem [ref=e1442]:
                            - generic [ref=e1449]:
                              - generic [ref=e1451]: Product Interest
                              - generic [ref=e1455]:
                                - combobox "Product Interest" [ref=e1456] [cursor=pointer]:
                                  - generic [ref=e1457]: "--None--"
                                - img [ref=e1461]
                              - status
                          - listitem [ref=e1465]:
                            - generic [ref=e1471]:
                              - generic [ref=e1472]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e1474]
                        - generic [ref=e1476]:
                          - listitem [ref=e1478]:
                            - generic [ref=e1484]:
                              - generic [ref=e1485]: SIC Code
                              - textbox "SIC Code" [ref=e1487]
                          - listitem [ref=e1489]:
                            - generic [ref=e1496]:
                              - generic [ref=e1498]: Primary
                              - generic [ref=e1502]:
                                - combobox "Primary" [ref=e1503] [cursor=pointer]:
                                  - generic [ref=e1504]: "--None--"
                                - img [ref=e1508]
                              - status
                        - listitem [ref=e1514]:
                          - generic [ref=e1519]:
                            - generic [ref=e1520]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e1522]
                  - generic [ref=e1525]:
                    - heading "Description Information" [level=3] [ref=e1526]:
                      - generic [ref=e1527]: Description Information
                    - list [ref=e1529]:
                      - listitem [ref=e1534]:
                        - generic [ref=e1538]:
                          - generic [ref=e1539]: Description
                          - textbox "Description" [ref=e1541]
                          - status
                - generic [ref=e1546]:
                  - generic "Cancel" [ref=e1547]:
                    - button "Cancel" [ref=e1552] [cursor=pointer]
                  - generic "Save & New" [ref=e1553]:
                    - button "Save & New" [ref=e1558] [cursor=pointer]
                  - generic "Save" [ref=e1559]:
                    - button "Save" [ref=e1564] [cursor=pointer]
          - status [ref=e1565]
  - generic:
    - status
```
