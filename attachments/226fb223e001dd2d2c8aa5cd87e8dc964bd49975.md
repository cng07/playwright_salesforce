...
Call log:
  - waiting for getByRole('combobox', { name: 'Salutation' })
    - locator resolved to <button type="button" role="combobox" name="salutation" lwc-4kb6kaqheak="" part="input-button" aria-expanded="false" data-value="--None--" aria-disabled="false" aria-required="false" aria-haspopup="listbox" aria-label="Salutation" id="combobox-button-681" aria-describedby="help-text-680" aria-controls="dropdown-element-681" class="slds-combobox__input slds-input_faux fix-slds-input_faux slds-combobox__input-value">…</button>
                        ...
                        - generic [ref=e1544]:
                          ...
                          - listitem [ref=e1562]:
                            ...
                            - generic [ref=e1573]:
                              ...
                              - textbox "Phone" [ref=e1576]: "0288702094"
                        - generic [ref=e1578]:
                          - listitem [ref=e1580]:
                            ...
                            - group "Name required" [ref=e1591]:
                              ...
                              - generic [ref=e1595]:
                                ...
                                - generic [ref=e1617]:
                                  ...
                                  - textbox "First Name" [ref=e1620]: Alexandro
                                - generic [ref=e1623]:
                                  - generic [ref=e1624]:
                          ...
                          - listitem [ref=e1634]:
                            ...
                            - generic [ref=e1645]:
                              ...
                              - textbox "Mobile" [ref=e1648]: "09043784588"
                        - generic [ref=e1650]:
                          - listitem [ref=e1652]:
                            ...
                            - generic [ref=e1664]:
                              ...
                              - textbox "Company" [ref=e1667]: Schoen - Schaefer
                          - listitem [ref=e1669]:
                            - button "Undo Fax" [ref=e1671] [cursor=pointer]:
                              - img [ref=e1673]
                            - generic [ref=e1680]:
                              - generic [ref=e1681]: Fax
                              - textbox "Fax" [ref=e1683]: "7731914187"
                        - generic [ref=e1685]:
                          - listitem [ref=e1687]:
                            ...
                            - generic [ref=e1699]:
                              ...
                              - textbox "Title" [ref=e1702]: Product Optimization Planner
                          - listitem [ref=e1704]:
                            - button "Undo Email" [ref=e1706] [cursor=pointer]:
                              - img [ref=e1708]
                            - generic [ref=e1715]:
                              - generic [ref=e1716]: Email
                              - textbox "Email" [ref=e1718]: alexandro.lynch48@hotmail.com
                        - generic [ref=e1720]:
                          - listitem [ref=e1722]:
                            - generic [ref=e1729]:
                              - generic [ref=e1731]: Lead Source
                              - generic [ref=e1735]:
                                - combobox "Lead Source" [ref=e1736] [cursor=pointer]:
                                  - generic [ref=e1737]: "--None--"
                                - img [ref=e1741]
                              - status
                          - listitem [ref=e1745]:
                            - button "Undo Website" [ref=e1747] [cursor=pointer]:
                              - img [ref=e1749]
                            - generic [ref=e1756]:
                              - generic [ref=e1757]: Website
                              - textbox "Website" [ref=e1759]: https://neat-pharmacopoeia.info/
                        - generic [ref=e1761]:
                          - listitem [ref=e1763]:
                            - generic [ref=e1770]:
                              - generic [ref=e1772]: Industry
                              - generic [ref=e1776]:
                                - combobox "Industry" [ref=e1777] [cursor=pointer]:
                                  - generic [ref=e1778]: "--None--"
                                - img [ref=e1782]
                              - status
                          - listitem [ref=e1786]:
                            - generic [ref=e1793]:
                              - generic [ref=e1795]: "*Lead Status"
                              - generic [ref=e1799]:
                                - combobox "Lead Status" [ref=e1800] [cursor=pointer]:
                                  - generic [ref=e1801]: Open - Not Contacted
                                - img [ref=e1805]
                              - status
                        - generic [ref=e1809]:
                          - listitem [ref=e1811]:
                            - button "Undo Annual Revenue" [ref=e1813] [cursor=pointer]:
                              - img [ref=e1815]
                            - generic [ref=e1823]:
                              - generic [ref=e1824]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e1826]: $977
                          - listitem [ref=e1828]:
                            - generic [ref=e1835]:
                              - generic [ref=e1837]: Rating
                              - generic [ref=e1841]:
                                - combobox "Rating" [ref=e1842] [cursor=pointer]:
                                  - generic [ref=e1843]: "--None--"
                                - img [ref=e1847]
                              - status
                        - listitem [ref=e1854]:
                          - button "Undo No. of Employees" [ref=e1856] [cursor=pointer]:
                            - img [ref=e1858]
                          - generic [ref=e1865]:
                            - generic [ref=e1866]: No. of Employees
                            - spinbutton "No. of Employees" [active] [ref=e1868]: "406"
                  - generic [ref=e1870]:
                    - heading "Address Information" [level=3] [ref=e1871]:
                      - generic [ref=e1872]: Address Information
                    - list [ref=e1874]:
                      - listitem [ref=e1879]:
                        - group "Address" [ref=e1884]:
                          - generic [ref=e1885]: Address
                          - generic [ref=e1887]:
                            - generic [ref=e1891]:
                              - generic [ref=e1893]: Country
                              - generic [ref=e1897]:
                                - combobox "Country" [ref=e1900]: "--None--"
                                - img [ref=e1904]
                              - status
                            - generic [ref=e1908]:
                              - generic [ref=e1909]: Street
                              - textbox "Street" [ref=e1911]
                              - status
                            - generic [ref=e1912]:
                              - generic [ref=e1915]:
                                - generic [ref=e1916]: City
                                - textbox "City" [ref=e1918]
                              - generic [ref=e1921]:
                                - generic [ref=e1923]: State/Province
                                - generic [ref=e1927]:
                                  - combobox "State/Province" [ref=e1930]: "--None--"
                                  - img [ref=e1934]
                                - status
                            - generic [ref=e1940]:
                              - generic [ref=e1941]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e1943]
                  - generic [ref=e1946]:
                    - heading "Additional Information" [level=3] [ref=e1947]:
                      - generic [ref=e1948]: Additional Information
                    - list [ref=e1950]:
                      - generic [ref=e1951]:
                        - generic [ref=e1953]:
                          - listitem [ref=e1955]:
                            - generic [ref=e1962]:
                              - generic [ref=e1964]: Product Interest
                              - generic [ref=e1968]:
                                - combobox "Product Interest" [ref=e1969] [cursor=pointer]:
                                  - generic [ref=e1970]: "--None--"
                                - img [ref=e1974]
                              - status
                          - listitem [ref=e1978]:
                            - generic [ref=e1984]:
                              - generic [ref=e1985]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e1987]
                        - generic [ref=e1989]:
                          - listitem [ref=e1991]:
                            - generic [ref=e1997]:
                              - generic [ref=e1998]: SIC Code
                              - textbox "SIC Code" [ref=e2000]
                          - listitem [ref=e2002]:
                            - generic [ref=e2009]:
                              - generic [ref=e2011]: Primary
                              - generic [ref=e2015]:
                                - combobox "Primary" [ref=e2016] [cursor=pointer]:
                                  - generic [ref=e2017]: "--None--"
                                - img [ref=e2021]
                              - status
                        - listitem [ref=e2027]:
                          - generic [ref=e2032]:
                            - generic [ref=e2033]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e2035]
                  - generic [ref=e2038]:
                    - heading "Description Information" [level=3] [ref=e2039]:
                      - generic [ref=e2040]: Description Information
                    - list [ref=e2042]:
                      - listitem [ref=e2047]:
                        - generic [ref=e2051]:
                          - generic [ref=e2052]: Description
                          - textbox "Description" [ref=e2054]
                          - status
                - generic [ref=e2059]:
                  - generic "Cancel" [ref=e2060]:
                    - button "Cancel" [ref=e2065] [cursor=pointer]
                  - generic "Save & New" [ref=e2066]:
                    - button "Save & New" [ref=e2071] [cursor=pointer]
                  - generic "Save" [ref=e2072]:
                    - button "Save" [ref=e2077] [cursor=pointer]
          - status [ref=e2078]
  - generic:
    - status
```
