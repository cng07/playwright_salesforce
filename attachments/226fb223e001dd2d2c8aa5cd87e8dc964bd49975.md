...
Call log:
  - waiting for getByRole('option', { name: 'Hot' })
    - locator resolved to <lightning-base-combobox-item role="option" data-value="Hot" lwc-4kb6kaqheak="" exportparts="option" aria-checked="false" aria-selected="false" lwc-7co8ha3nedg-host="" id="combobox-button-895-1-895" data-item-id="combobox-button-895-1" class="slds-media slds-listbox__option slds-media_center slds-media_small slds-listbox__option_plain">…</lightning-base-combobox-item>
                        ...
                        - generic [ref=e1808]:
                          ...
                          - listitem [ref=e1826]:
                            ...
                            - generic [ref=e1837]:
                              ...
                              - textbox "Phone" [ref=e1840]: "0239477911"
                        - generic [ref=e1842]:
                          - listitem [ref=e1844]:
                                ...
                                - generic [ref=e1863]:
                                  ...
                                  - generic [ref=e1869]:
                                    - combobox "Salutation" [ref=e1870] [cursor=pointer]:
                                      - generic [ref=e1871]: Mx.
                                    - img [ref=e1875]
                                  - status
                                - generic [ref=e1881]:
                                  - generic [ref=e1882]: First Name
                                  - textbox "First Name" [ref=e1884]: Velda
                                - generic [ref=e1888]:
                                  - generic [ref=e1889]: "*Last Name"
                                  - textbox "Last Name" [ref=e1891]: Morar
                          - listitem [ref=e1893]:
                            - button "Undo Mobile" [ref=e1895] [cursor=pointer]:
                              - img [ref=e1897]
                            - generic [ref=e1904]:
                              - generic [ref=e1905]: Mobile
                              - textbox "Mobile" [ref=e1907]: "09850859233"
                        - generic [ref=e1909]:
                          - listitem [ref=e1911]:
                            ...
                            - generic [ref=e1923]:
                              ...
                              - textbox "Company" [ref=e1926]: Reichert LLC
                          - listitem [ref=e1928]:
                            - button "Undo Fax" [ref=e1930] [cursor=pointer]:
                              - img [ref=e1932]
                            - generic [ref=e1939]:
                              - generic [ref=e1940]: Fax
                              - textbox "Fax" [ref=e1942]: "9894245934"
                        - generic [ref=e1944]:
                          - listitem [ref=e1946]:
                            ...
                            - generic [ref=e1958]:
                              ...
                              - textbox "Title" [ref=e1961]: Principal Web Associate
                          - listitem [ref=e1963]:
                            - button "Undo Email" [ref=e1965] [cursor=pointer]:
                              - img [ref=e1967]
                            - generic [ref=e1974]:
                              - generic [ref=e1975]: Email
                              - textbox "Email" [ref=e1977]: velda_morar92@gmail.com
                        - generic [ref=e1979]:
                          - listitem [ref=e1981]:
                          ...
                          - listitem [ref=e2010]:
                            ...
                            - generic [ref=e2021]:
                              ...
                              - textbox "Website" [ref=e2024]: https://crazy-heroine.com
                        - generic [ref=e2026]:
                          - listitem [ref=e2028]:
                          ...
                          - listitem [ref=e2057]:
                            - generic [ref=e2064]:
                              ...
                              - generic [ref=e2070]:
                                - combobox "Lead Status" [ref=e2071] [cursor=pointer]:
                        ...
                        - generic [ref=e2080]:
                          - listitem [ref=e2082]:
                            ...
                            - generic [ref=e2094]:
                              ...
                              - spinbutton "Annual Revenue" [ref=e2097]: $333
                          - listitem [ref=e2099]:
                            - generic [ref=e2106]:
                              - generic [ref=e2108]: Rating
                              - generic [ref=e2112]:
                                - combobox "Rating" [expanded] [active] [ref=e2113] [cursor=pointer]:
                                  - generic [ref=e2114]: "--None--"
                                - img [ref=e2118]
                                - listbox "Rating" [ref=e2121]:
                                  - option "--None--" [checked] [selected] [ref=e2122]:
                                    - img [ref=e2127]
                                    - generic [ref=e2130]: "--None--"
                                  - option "Hot" [ref=e2131]:
                                    - generic [ref=e2132]: Hot
                                  - option "Warm" [ref=e2133]:
                                    - generic [ref=e2134]: Warm
                                  - option "Cold" [ref=e2135]:
                                    - generic [ref=e2136]: Cold
                              - status
                        - listitem [ref=e2141]:
                          - button "Undo No. of Employees" [ref=e2143] [cursor=pointer]:
                            - img [ref=e2145]
                          - generic [ref=e2152]:
                            - generic [ref=e2153]: No. of Employees
                            - spinbutton "No. of Employees" [ref=e2155]: "994"
                  - generic [ref=e2157]:
                    - heading "Address Information" [level=3] [ref=e2158]:
                      - generic [ref=e2159]: Address Information
                    - list [ref=e2161]:
                      - listitem [ref=e2166]:
                        - group "Address" [ref=e2171]:
                          - generic [ref=e2172]: Address
                          - generic [ref=e2174]:
                            - generic [ref=e2178]:
                              - generic [ref=e2180]: Country
                              - generic [ref=e2184]:
                                - combobox "Country" [ref=e2187]: "--None--"
                                - img [ref=e2191]
                              - status
                            - generic [ref=e2195]:
                              - generic [ref=e2196]: Street
                              - textbox "Street" [ref=e2198]
                              - status
                            - generic [ref=e2199]:
                              - generic [ref=e2202]:
                                - generic [ref=e2203]: City
                                - textbox "City" [ref=e2205]
                              - generic [ref=e2208]:
                                - generic [ref=e2210]: State/Province
                                - generic [ref=e2214]:
                                  - combobox "State/Province" [ref=e2217]: "--None--"
                                  - img [ref=e2221]
                                - status
                            - generic [ref=e2227]:
                              - generic [ref=e2228]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e2230]
                  - generic [ref=e2233]:
                    - heading "Additional Information" [level=3] [ref=e2234]:
                      - generic [ref=e2235]: Additional Information
                    - list [ref=e2237]:
                      - generic [ref=e2238]:
                        - generic [ref=e2240]:
                          - listitem [ref=e2242]:
                            - generic [ref=e2249]:
                              - generic [ref=e2251]: Product Interest
                              - generic [ref=e2255]:
                                - combobox "Product Interest" [ref=e2256] [cursor=pointer]:
                                  - generic [ref=e2257]: "--None--"
                                - img [ref=e2261]
                              - status
                          - listitem [ref=e2265]:
                            - generic [ref=e2271]:
                              - generic [ref=e2272]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e2274]
                        - generic [ref=e2276]:
                          - listitem [ref=e2278]:
                            - generic [ref=e2284]:
                              - generic [ref=e2285]: SIC Code
                              - textbox "SIC Code" [ref=e2287]
                          - listitem [ref=e2289]:
                            - generic [ref=e2296]:
                              - generic [ref=e2298]: Primary
                              - generic [ref=e2302]:
                                - combobox "Primary" [ref=e2303] [cursor=pointer]:
                                  - generic [ref=e2304]: "--None--"
                                - img [ref=e2308]
                              - status
                        - listitem [ref=e2314]:
                          - generic [ref=e2319]:
                            - generic [ref=e2320]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e2322]
                  - generic [ref=e2325]:
                    - heading "Description Information" [level=3] [ref=e2326]:
                      - generic [ref=e2327]: Description Information
                    - list [ref=e2329]:
                      - listitem [ref=e2334]:
                        - generic [ref=e2338]:
                          - generic [ref=e2339]: Description
                          - textbox "Description" [ref=e2341]
                          - status
                - generic [ref=e2346]:
                  - generic "Cancel" [ref=e2347]:
                    - button "Cancel" [ref=e2352] [cursor=pointer]
                  - generic "Save & New" [ref=e2353]:
                    - button "Save & New" [ref=e2358] [cursor=pointer]
                  - generic "Save" [ref=e2359]:
                    - button "Save" [ref=e2364] [cursor=pointer]
          - status [ref=e2365]
  - generic:
    - status
```
