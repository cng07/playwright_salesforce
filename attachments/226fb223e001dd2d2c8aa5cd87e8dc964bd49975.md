...
- main:
  ...
  - group "Key Performance Indicators":
    - button "Total Leads 19" [pressed]:
      - paragraph: Total Leads
      - paragraph: "19"
    - button "No Activity 19":
...
- contentinfo "Utility Bar":
  - list:
    - listitem:
      - button "To Do List"
- status: Success notification..Lead "Dr. Caroline Nolan" was saved. Press Command + F6 to navigate to the next toast notification or focusable region.
```
