...
- main:
  ...
  - group "Key Performance Indicators":
    - button "Total Leads 22" [pressed]:
      - paragraph: Total Leads
      - paragraph: "22"
    - button "No Activity 22":
    ...
    - button "Upcoming 0":
      ...
      - paragraph: "0"
    - button "Help"
  - status: 22 items • Filtered by Created Date, Me, Total Leads
  - group:
  ...
  - grid:
    - rowgroup:
      - row "Row Number Choose a Row Select 22 items Name Important Title Company Lead Status Lead Source Last Activity Actions Action":
        - columnheader "Row Number"
        - gridcell "Choose a Row Select 22 items":
          - text: Choose a Row
          - checkbox "Select 22 items"
          - text: Select 22 items
        - columnheader "Name":
          - 'button "Sort by: Name"'
          - text: "Sorted: None"
