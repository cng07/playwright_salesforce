...
Call log:
  ...
  - waiting for getByText('was created.')
    2 × locator resolved to <span data-aura-rendered-by="1312:0" data-aura-class="forceActionsText" class="toastMessage slds-text-heading--small forceActionsText">…</span>
...
- main:
  - heading "Lead Ms. Berge" [level=1]
  - button "New Case"
  - button "New Note"
  - button "Submit for Approval"
  - button "Show more actions"
  - paragraph: Title
  - paragraph: Senior Creative Associate
  - paragraph: Company
  - paragraph: Ledner, Kling and Glover
  - button "Phone (2)":
    - paragraph: Phone (2)
  - list:
    - paragraph:
      - link "(021) 277-6775":
        - /url: tel:0212776775
  - paragraph: Email
  - paragraph: estella_berge@hotmail.com
