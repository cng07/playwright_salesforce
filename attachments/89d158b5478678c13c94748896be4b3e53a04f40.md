...
Call log:
  - waiting for getByRole('option', { name: 'Web' })
    - locator resolved to <lightning-base-combobox-item role="option" data-value="Web" lwc-4kb6kaqheak="" exportparts="option" aria-checked="false" aria-selected="false" lwc-7co8ha3nedg-host="" id="combobox-button-730-1-730" data-item-id="combobox-button-730-1" class="slds-media slds-listbox__option slds-media_center slds-media_small slds-listbox__option_plain">…</lightning-base-combobox-item>
                        ...
                        - generic [ref=e1412]:
                          ...
                          - listitem [ref=e1430]:
                            ...
                            - generic [ref=e1441]:
                              ...
                              - textbox "Phone" [ref=e1444]: "0295322931"
                        - generic [ref=e1446]:
                          - listitem [ref=e1448]:
                                ...
                                - generic [ref=e1467]:
                                  ...
                                  - generic [ref=e1473]:
                                    - combobox "Salutation" [ref=e1474] [cursor=pointer]:
                                      - generic [ref=e1475]: Dr.
                                    - img [ref=e1479]
                                  - status
                                - generic [ref=e1485]:
                                  - generic [ref=e1486]: First Name
                                  - textbox "First Name" [ref=e1488]: Ernest
                                - generic [ref=e1492]:
                                  - generic [ref=e1493]: "*Last Name"
                                  - textbox "Last Name" [ref=e1495]: Fay
                          - listitem [ref=e1497]:
                            - button "Undo Mobile" [ref=e1499] [cursor=pointer]:
                              - img [ref=e1501]
                            - generic [ref=e1508]:
                              - generic [ref=e1509]: Mobile
                              - textbox "Mobile" [ref=e1511]: "09661054188"
                        - generic [ref=e1513]:
                          - listitem [ref=e1515]:
                            ...
                            - generic [ref=e1527]:
                              ...
                              - textbox "Company" [ref=e1530]: Hamill - Morissette
                          - listitem [ref=e1532]:
                            - button "Undo Fax" [ref=e1534] [cursor=pointer]:
                              - img [ref=e1536]
                            - generic [ref=e1543]:
                              - generic [ref=e1544]: Fax
                              - textbox "Fax" [ref=e1546]: "0270979451"
                        - generic [ref=e1548]:
                          - listitem [ref=e1550]:
                            ...
                            - generic [ref=e1562]:
                              ...
                              - textbox "Title" [ref=e1565]: Human Branding Agent
                          - listitem [ref=e1567]:
                            - button "Undo Email" [ref=e1569] [cursor=pointer]:
                              - img [ref=e1571]
                            - generic [ref=e1578]:
                              - generic [ref=e1579]: Email
                              - textbox "Email" [ref=e1581]: ernest_fay@yahoo.com
                        - generic [ref=e1583]:
                          - listitem [ref=e1585]:
                            - generic [ref=e1592]:
                              - generic [ref=e1594]: Lead Source
                              - generic [ref=e1598]:
                                - combobox "Lead Source" [expanded] [active] [ref=e1599] [cursor=pointer]:
                                  - generic [ref=e1600]: "--None--"
                                - img [ref=e1604]
                                - listbox "Lead Source" [ref=e1607]:
                                  - option "--None--" [checked] [selected] [ref=e1608]:
                                    - img [ref=e1613]
                                    - generic [ref=e1616]: "--None--"
                                  - option "Web" [ref=e1617]:
                                    - generic [ref=e1618]: Web
                                  - option "Phone Inquiry" [ref=e1619]:
                                    - generic [ref=e1620]: Phone Inquiry
                                  - option "Partner Referral" [ref=e1621]:
                                    - generic [ref=e1622]: Partner Referral
                                  - option "Purchased List" [ref=e1623]:
                                    - generic [ref=e1624]: Purchased List
                                  - option "Other" [ref=e1625]:
                                    - generic [ref=e1626]: Other
                              - status
                          - listitem [ref=e1628]:
                            - button "Undo Website" [ref=e1630] [cursor=pointer]:
                              - img [ref=e1632]
                            - generic [ref=e1639]:
                              - generic [ref=e1640]: Website
                              - textbox "Website" [ref=e1642]: https://unfit-feather.info/
                        - generic [ref=e1644]:
                          - listitem [ref=e1646]:
                            - generic [ref=e1653]:
                              - generic [ref=e1655]: Industry
                              - generic [ref=e1659]:
                                - combobox "Industry" [ref=e1660] [cursor=pointer]:
                                  - generic [ref=e1661]: "--None--"
                                - img [ref=e1665]
                              - status
                          - listitem [ref=e1669]:
                            - generic [ref=e1676]:
                              - generic [ref=e1678]: "*Lead Status"
                              - generic [ref=e1682]:
                                - combobox "Lead Status" [ref=e1683] [cursor=pointer]:
                                  - generic [ref=e1684]: Open - Not Contacted
                                - img [ref=e1688]
                              - status
                        - generic [ref=e1692]:
                          - listitem [ref=e1694]:
                            - button "Undo Annual Revenue" [ref=e1696] [cursor=pointer]:
                              - img [ref=e1698]
                            - generic [ref=e1706]:
                              - generic [ref=e1707]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e1709]: $990
                          - listitem [ref=e1711]:
                            - generic [ref=e1718]:
                              - generic [ref=e1720]: Rating
                              - generic [ref=e1724]:
                                - combobox "Rating" [ref=e1725] [cursor=pointer]:
                                  - generic [ref=e1726]: "--None--"
                                - img [ref=e1730]
                              - status
                        - listitem [ref=e1737]:
                          - button "Undo No. of Employees" [ref=e1739] [cursor=pointer]:
                            - img [ref=e1741]
                          - generic [ref=e1748]:
                            - generic [ref=e1749]: No. of Employees
                            - spinbutton "No. of Employees" [ref=e1751]: "524"
                  - generic [ref=e1753]:
                    - heading "Address Information" [level=3] [ref=e1754]:
                      - generic [ref=e1755]: Address Information
                    - list [ref=e1757]:
                      - listitem [ref=e1762]:
                        - group "Address" [ref=e1767]:
                          - generic [ref=e1768]: Address
                          - generic [ref=e1770]:
                            - generic [ref=e1774]:
                              - generic [ref=e1776]: Country
                              - generic [ref=e1780]:
                                - combobox "Country" [ref=e1783]: "--None--"
                                - img [ref=e1787]
                              - status
                            - generic [ref=e1791]:
                              - generic [ref=e1792]: Street
                              - textbox "Street" [ref=e1794]
                              - status
                            - generic [ref=e1795]:
                              - generic [ref=e1798]:
                                - generic [ref=e1799]: City
                                - textbox "City" [ref=e1801]
                              - generic [ref=e1804]:
                                - generic [ref=e1806]: State/Province
                                - generic [ref=e1810]:
                                  - combobox "State/Province" [ref=e1813]: "--None--"
                                  - img [ref=e1817]
                                - status
                            - generic [ref=e1823]:
                              - generic [ref=e1824]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e1826]
                  - generic [ref=e1829]:
                    - heading "Additional Information" [level=3] [ref=e1830]:
                      - generic [ref=e1831]: Additional Information
                    - list [ref=e1833]:
                      - generic [ref=e1834]:
                        - generic [ref=e1836]:
                          - listitem [ref=e1838]:
                            - generic [ref=e1845]:
                              - generic [ref=e1847]: Product Interest
                              - generic [ref=e1851]:
                                - combobox "Product Interest" [ref=e1852] [cursor=pointer]:
                                  - generic [ref=e1853]: "--None--"
                                - img [ref=e1857]
                              - status
                          - listitem [ref=e1861]:
                            - generic [ref=e1867]:
                              - generic [ref=e1868]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e1870]
                        - generic [ref=e1872]:
                          - listitem [ref=e1874]:
                            - generic [ref=e1880]:
                              - generic [ref=e1881]: SIC Code
                              - textbox "SIC Code" [ref=e1883]
                          - listitem [ref=e1885]:
                            - generic [ref=e1892]:
                              - generic [ref=e1894]: Primary
                              - generic [ref=e1898]:
                                - combobox "Primary" [ref=e1899] [cursor=pointer]:
                                  - generic [ref=e1900]: "--None--"
                                - img [ref=e1904]
                              - status
                        - listitem [ref=e1910]:
                          - generic [ref=e1915]:
                            - generic [ref=e1916]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e1918]
                  - generic [ref=e1921]:
                    - heading "Description Information" [level=3] [ref=e1922]:
                      - generic [ref=e1923]: Description Information
                    - list [ref=e1925]:
                      - listitem [ref=e1930]:
                        - generic [ref=e1934]:
                          - generic [ref=e1935]: Description
                          - textbox "Description" [ref=e1937]
                          - status
                - generic [ref=e1942]:
                  - generic "Cancel" [ref=e1943]:
                    - button "Cancel" [ref=e1948] [cursor=pointer]
                  - generic "Save & New" [ref=e1949]:
                    - button "Save & New" [ref=e1954] [cursor=pointer]
                  - generic "Save" [ref=e1955]:
                    - button "Save" [ref=e1960] [cursor=pointer]
          - status [ref=e1961]
  - generic:
    - status
```
