...
Call log:
  - waiting for getByRole('option', { name: 'Closed - Converted' })
    - locator resolved to <lightning-base-combobox-item role="option" lwc-4kb6kaqheak="" exportparts="option" aria-checked="false" aria-selected="false" lwc-7co8ha3nedg-host="" id="combobox-button-733-3-733" data-value="Closed - Converted" data-item-id="combobox-button-733-3" class="slds-media slds-listbox__option slds-media_center slds-media_small slds-listbox__option_plain">…</lightning-base-combobox-item>
                          ...
                          - generic [ref=e1375]:
                            - generic [ref=e1379]:
                              - link [ref=e1382] [cursor=pointer]:
                                - /url: /lightning/r/Lead/00Qg5000005MRWXEA4/view
                                - generic [ref=e1383]: Mercedes Sporer
                              - button [ref=e1385] [cursor=pointer]:
                                - img [ref=e1387]
                                - generic [ref=e1390]: "View Activity: Mercedes Sporer"
                            - img [ref=e1391]:
                              - img [ref=e1393]
                        - gridcell [ref=e1396]:
                          - button [ref=e1405] [cursor=pointer]:
                            - img [ref=e1407]
                            - generic [ref=e1410]: "Mark Important: Mercedes Sporer"
                        - gridcell [ref=e1411]:
                          - generic [ref=e1413]:
                            - generic [ref=e1416]: Corporate Quality Executive
                            - button [ref=e1417] [cursor=pointer]:
                              - img [ref=e1419]
                              - generic [ref=e1422]: Edit Title
                        - gridcell [ref=e1423]:
                          - generic [ref=e1425]:
                            - generic [ref=e1428]: Schulist - Stiedemann-McDermott
                            - button [ref=e1429] [cursor=pointer]:
                              - img [ref=e1431]
                              - generic [ref=e1434]: Edit Company
                        - gridcell [ref=e1435]:
                          - generic [ref=e1437]:
                            - generic [ref=e1440]: Closed - Converted
                            - button [ref=e1441] [cursor=pointer]:
                              - img [ref=e1443]
                              - generic [ref=e1446]: Edit Lead Status
                        - gridcell [ref=e1447]:
                          - generic [ref=e1449]:
                            - generic [ref=e1452]: Partner Referral
                        ...
                        - generic [ref=e1544]:
                          ...
                          - listitem [ref=e1562]:
                            ...
                            - generic [ref=e1573]:
                              ...
                              - textbox "Phone" [ref=e1576]: "0283042637"
                        - generic [ref=e1578]:
                          - listitem [ref=e1580]:
                                ...
                                - generic [ref=e1599]:
                                  ...
                                  - generic [ref=e1605]:
                                    - combobox "Salutation" [ref=e1606] [cursor=pointer]:
                                      - generic [ref=e1607]: Dr.
                                    - img [ref=e1611]
                                  - status
                                - generic [ref=e1617]:
                                  - generic [ref=e1618]: First Name
                                  - textbox "First Name" [ref=e1620]: George
                                - generic [ref=e1624]:
                                  - generic [ref=e1625]: "*Last Name"
                                  - textbox "Last Name" [ref=e1627]: Franecki-Ankunding
                          - listitem [ref=e1629]:
                            - button "Undo Mobile" [ref=e1631] [cursor=pointer]:
                              - img [ref=e1633]
                            - generic [ref=e1640]:
                              - generic [ref=e1641]: Mobile
                              - textbox "Mobile" [ref=e1643]: "09837332297"
                        - generic [ref=e1645]:
                          - listitem [ref=e1647]:
                            ...
                            - generic [ref=e1659]:
                              ...
                              - textbox "Company" [ref=e1662]: Wiegand, Hartmann and Heaney-Gislason
                          - listitem [ref=e1664]:
                            - button "Undo Fax" [ref=e1666] [cursor=pointer]:
                              - img [ref=e1668]
                            - generic [ref=e1675]:
                              - generic [ref=e1676]: Fax
                              - textbox "Fax" [ref=e1678]: "3373629106"
                        - generic [ref=e1680]:
                          - listitem [ref=e1682]:
                            ...
                            - generic [ref=e1694]:
                              ...
                              - textbox "Title" [ref=e1697]: District Security Planner
                          - listitem [ref=e1699]:
                            - button "Undo Email" [ref=e1701] [cursor=pointer]:
                              - img [ref=e1703]
                            - generic [ref=e1710]:
                              - generic [ref=e1711]: Email
                              - textbox "Email" [ref=e1713]: george_franecki-ankunding@gmail.com
                        - generic [ref=e1715]:
                          - listitem [ref=e1717]:
                          ...
                          - listitem [ref=e1746]:
                            ...
                            - generic [ref=e1757]:
                              ...
                              - textbox "Website" [ref=e1760]: https://light-disappointment.org
                        - generic [ref=e1762]:
                          - listitem [ref=e1764]:
                            ...
                            - generic [ref=e1777]:
                              ...
                              - generic [ref=e1783]:
                                - combobox "Industry" [ref=e1784] [cursor=pointer]:
                                  - generic [ref=e1785]: Engineering
                                - img [ref=e1789]
                              - status
                          - listitem [ref=e1793]:
                            - generic [ref=e1800]:
                              - generic [ref=e1802]: "*Lead Status"
                              - generic [ref=e1806]:
                                - combobox "Lead Status" [expanded] [active] [ref=e1807] [cursor=pointer]:
                                  - generic [ref=e1808]: Open - Not Contacted
                                - img [ref=e1812]
                                - listbox "Lead Status" [ref=e1815]:
                                  - option "--None--" [ref=e1816]:
                                    - generic [ref=e1817]: "--None--"
                                  - option "Open - Not Contacted" [checked] [selected] [ref=e1818]:
                                    - img [ref=e1823]
                                    - generic [ref=e1826]: Open - Not Contacted
                                  - option "Working - Contacted" [ref=e1827]:
                                    - generic [ref=e1828]: Working - Contacted
                                  - option "Closed - Converted" [ref=e1829]:
                                    - generic [ref=e1830]: Closed - Converted
                                  - option "Closed - Not Converted" [ref=e1831]:
                                    - generic [ref=e1832]: Closed - Not Converted
                              - status
                        - generic [ref=e1834]:
                          - listitem [ref=e1836]:
                            - button "Undo Annual Revenue" [ref=e1838] [cursor=pointer]:
                              - img [ref=e1840]
                            - generic [ref=e1848]:
                              - generic [ref=e1849]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e1851]: $303
                          - listitem [ref=e1853]:
                            - generic [ref=e1860]:
                              - generic [ref=e1862]: Rating
                              - generic [ref=e1866]:
                                - combobox "Rating" [ref=e1867] [cursor=pointer]:
                                  - generic [ref=e1868]: "--None--"
                                - img [ref=e1872]
                              - status
                        - listitem [ref=e1879]:
                          - button "Undo No. of Employees" [ref=e1881] [cursor=pointer]:
                            - img [ref=e1883]
                          - generic [ref=e1890]:
                            - generic [ref=e1891]: No. of Employees
                            - spinbutton "No. of Employees" [ref=e1893]: "699"
                  - generic [ref=e1895]:
                    - heading "Address Information" [level=3] [ref=e1896]:
                      - generic [ref=e1897]: Address Information
                    - list [ref=e1899]:
                      - listitem [ref=e1904]:
                        - group "Address" [ref=e1909]:
                          - generic [ref=e1910]: Address
                          - generic [ref=e1912]:
                            - generic [ref=e1916]:
                              - generic [ref=e1918]: Country
                              - generic [ref=e1922]:
                                - combobox "Country" [ref=e1925]: "--None--"
                                - img [ref=e1929]
                              - status
                            - generic [ref=e1933]:
                              - generic [ref=e1934]: Street
                              - textbox "Street" [ref=e1936]
                              - status
                            - generic [ref=e1937]:
                              - generic [ref=e1940]:
                                - generic [ref=e1941]: City
                                - textbox "City" [ref=e1943]
                              - generic [ref=e1946]:
                                - generic [ref=e1948]: State/Province
                                - generic [ref=e1952]:
                                  - combobox "State/Province" [ref=e1955]: "--None--"
                                  - img [ref=e1959]
                                - status
                            - generic [ref=e1965]:
                              - generic [ref=e1966]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e1968]
                  - generic [ref=e1971]:
                    - heading "Additional Information" [level=3] [ref=e1972]:
                      - generic [ref=e1973]: Additional Information
                    - list [ref=e1975]:
                      - generic [ref=e1976]:
                        - generic [ref=e1978]:
                          - listitem [ref=e1980]:
                            - generic [ref=e1987]:
                              - generic [ref=e1989]: Product Interest
                              - generic [ref=e1993]:
                                - combobox "Product Interest" [ref=e1994] [cursor=pointer]:
                                  - generic [ref=e1995]: "--None--"
                                - img [ref=e1999]
                              - status
                          - listitem [ref=e2003]:
                            - generic [ref=e2009]:
                              - generic [ref=e2010]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e2012]
                        - generic [ref=e2014]:
                          - listitem [ref=e2016]:
                            - generic [ref=e2022]:
                              - generic [ref=e2023]: SIC Code
                              - textbox "SIC Code" [ref=e2025]
                          - listitem [ref=e2027]:
                            - generic [ref=e2034]:
                              - generic [ref=e2036]: Primary
                              - generic [ref=e2040]:
                                - combobox "Primary" [ref=e2041] [cursor=pointer]:
                                  - generic [ref=e2042]: "--None--"
                                - img [ref=e2046]
                              - status
                        - listitem [ref=e2052]:
                          - generic [ref=e2057]:
                            - generic [ref=e2058]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e2060]
                  - generic [ref=e2063]:
                    - heading "Description Information" [level=3] [ref=e2064]:
                      - generic [ref=e2065]: Description Information
                    - list [ref=e2067]:
                      - listitem [ref=e2072]:
                        - generic [ref=e2076]:
                          - generic [ref=e2077]: Description
                          - textbox "Description" [ref=e2079]
                          - status
                - generic [ref=e2084]:
                  - generic "Cancel" [ref=e2085]:
                    - button "Cancel" [ref=e2090] [cursor=pointer]
                  - generic "Save & New" [ref=e2091]:
                    - button "Save & New" [ref=e2096] [cursor=pointer]
                  - generic "Save" [ref=e2097]:
                    - button "Save" [ref=e2102] [cursor=pointer]
          - status [ref=e2103]
  - generic:
    - status
```
