...
- main:
  - heading "Opportunity Krajcik, Rowe and Kutch-" [level=1]
  - button "Follow"
  - button "New Case"
  - button "New Note"
  - button "Clone"
  ...
  - paragraph:
    - link "Krajcik, Rowe and Kutch":
      - /url: /lightning/r/Account/001g500000TqaLGAAZ/view
    - button "Preview"
  ...
  - tabpanel "Details":
    - list:
      ...
      - listitem:
        - text: Opportunity Name Krajcik, Rowe and Kutch-
    ...
    - list:
      - listitem:
        - link "Delivery Status":
          - /url: /servlet/servlet.Integration?lid=00bg5000001cLu6&eid=006g5000005S6pBAAS&ic=1
  - heading "Tabs" [level=2]
  - heading "Tabs" [level=2]
  - tablist "Tabs":
  ...
  - tabpanel "Related":
    - article "Products":
      - heading "Products (0)" [level=2]:
        - link "Products (0)":
          - /url: /lightning/r/Opportunity/006g5000005S6pBAAS/related/OpportunityLineItems/view
      - button "Show actions for Products"
    - article "Notes & Attachments":
      - heading "Notes & Attachments (0)" [level=2]:
        - link "Notes & Attachments (0)":
          - /url: /lightning/r/Opportunity/006g5000005S6pBAAS/related/CombinedAttachments/view
    ...
    - article "Contact Roles":
      - heading "Contact Roles (1)" [level=2]:
        - link "Contact Roles (1)":
          - /url: /lightning/r/Opportunity/006g5000005S6pBAAS/related/OpportunityContactRoles/view
      - button "Show actions for Contact Roles"
      - list:
        - listitem:
          - article:
            - heading "Favian Lockman Favian Lockman primary" [level=3]:
              - img "Favian Lockman"
              - link "Favian Lockman":
                - /url: /lightning/r/003g500000O8S4YAAV/view
              - text: primary
            - button "Show Actions"
            - list:
              - listitem: "Role:"
              - listitem: "Title: International Research Agent"
