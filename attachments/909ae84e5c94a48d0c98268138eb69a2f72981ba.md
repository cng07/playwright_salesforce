...
Call log:
  - waiting for getByRole('combobox', { name: 'Lead Status' })
    - locator resolved to <button type="button" role="combobox" lwc-4kb6kaqheak="" part="input-button" aria-required="true" aria-expanded="false" aria-disabled="false" aria-haspopup="listbox" id="combobox-button-662" aria-label="Lead Status" data-value="Open - Not Contacted" aria-controls="dropdown-element-662" class="slds-combobox__input slds-input_faux fix-slds-input_faux slds-combobox__input-value">…</button>
                        ...
                        - generic [ref=e1148]:
                          ...
                          - listitem [ref=e1166]:
                            ...
                            - generic [ref=e1177]:
                              ...
                              - textbox "Phone" [ref=e1180]: "0245791264"
                        - generic [ref=e1182]:
                          - listitem [ref=e1184]:
                                ...
                                - generic [ref=e1203]:
                                  ...
                                  - generic [ref=e1209]:
                                    - combobox "Salutation" [ref=e1210] [cursor=pointer]:
                                      - generic [ref=e1211]: Ms.
                                    - img [ref=e1215]
                                  - status
                                - generic [ref=e1221]:
                                  - generic [ref=e1222]: First Name
                                  - textbox "First Name" [ref=e1224]: Charles
                                - generic [ref=e1228]:
                                  - generic [ref=e1229]: "*Last Name"
                                  - textbox "Last Name" [ref=e1231]: Renner
                          - listitem [ref=e1233]:
                            - button "Undo Mobile" [ref=e1235] [cursor=pointer]:
                              - img [ref=e1237]
                            - generic [ref=e1244]:
                              - generic [ref=e1245]: Mobile
                              - textbox "Mobile" [ref=e1247]: "09467561825"
                        - generic [ref=e1249]:
                          - listitem [ref=e1251]:
                            ...
                            - generic [ref=e1263]:
                              ...
                              - textbox "Company" [ref=e1266]: Cummings, Kuphal and Lakin
                          - listitem [ref=e1268]:
                            - button "Undo Fax" [ref=e1270] [cursor=pointer]:
                              - img [ref=e1272]
                            - generic [ref=e1279]:
                              - generic [ref=e1280]: Fax
                              - textbox "Fax" [ref=e1282]: "5333759216"
                        - generic [ref=e1284]:
                          - listitem [ref=e1286]:
                            ...
                            - generic [ref=e1298]:
                              ...
                              - textbox "Title" [ref=e1301]: Dynamic Tactics Strategist
                          - listitem [ref=e1303]:
                            - button "Undo Email" [ref=e1305] [cursor=pointer]:
                              - img [ref=e1307]
                            - generic [ref=e1314]:
                              - generic [ref=e1315]: Email
                              - textbox "Email" [ref=e1317]: charles.renner@hotmail.com
                        - generic [ref=e1319]:
                          - listitem [ref=e1321]:
                            - button "Undo Lead Source" [ref=e1323] [cursor=pointer]:
                              - img [ref=e1325]
                            - generic [ref=e1334]:
                              - generic [ref=e1336]: Lead Source
                              - generic [ref=e1340]:
                                - combobox "Lead Source" [ref=e1341] [cursor=pointer]:
                                  - generic [ref=e1342]: Partner Referral
                                - img [ref=e1346]
                              - status
                          - listitem [ref=e1350]:
                            - button "Undo Website" [ref=e1352] [cursor=pointer]:
                              - img [ref=e1354]
                            - generic [ref=e1361]:
                              - generic [ref=e1362]: Website
                              - textbox "Website" [ref=e1364]: https://both-schnitzel.info
                        - generic [ref=e1366]:
                          - listitem [ref=e1368]:
                            - button "Undo Industry" [ref=e1370] [cursor=pointer]:
                              - img [ref=e1372]
                            - generic [ref=e1381]:
                              - generic [ref=e1383]: Industry
                              - generic [ref=e1387]:
                                - combobox "Industry" [active] [ref=e1388] [cursor=pointer]:
                                  - generic [ref=e1389]: Consulting
                                - img [ref=e1393]
                              - status
                          - listitem [ref=e1397]:
                            - generic [ref=e1404]:
                              - generic [ref=e1406]: "*Lead Status"
                              - generic [ref=e1410]:
                                - combobox "Lead Status" [ref=e1411] [cursor=pointer]:
                                  - generic [ref=e1412]: Open - Not Contacted
                                - img [ref=e1416]
                              - status
                        - generic [ref=e1420]:
                          - listitem [ref=e1422]:
                            - button "Undo Annual Revenue" [ref=e1424] [cursor=pointer]:
                              - img [ref=e1426]
                            - generic [ref=e1434]:
                              - generic [ref=e1435]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e1437]: $404
                          - listitem [ref=e1439]:
                            - generic [ref=e1446]:
                              - generic [ref=e1448]: Rating
                              - generic [ref=e1452]:
                                - combobox "Rating" [ref=e1453] [cursor=pointer]:
                                  - generic [ref=e1454]: "--None--"
                                - img [ref=e1458]
                              - status
                        - listitem [ref=e1465]:
                          - button "Undo No. of Employees" [ref=e1467] [cursor=pointer]:
                            - img [ref=e1469]
                          - generic [ref=e1476]:
                            - generic [ref=e1477]: No. of Employees
                            - spinbutton "No. of Employees" [ref=e1479]: "831"
                  - generic [ref=e1481]:
                    - heading "Address Information" [level=3] [ref=e1482]:
                      - generic [ref=e1483]: Address Information
                    - list [ref=e1485]:
                      - listitem [ref=e1490]:
                        - group "Address" [ref=e1495]:
                          - generic [ref=e1496]: Address
                          - generic [ref=e1498]:
                            - generic [ref=e1502]:
                              - generic [ref=e1504]: Country
                              - generic [ref=e1508]:
                                - combobox "Country" [ref=e1511]: "--None--"
                                - img [ref=e1515]
                              - status
                            - generic [ref=e1519]:
                              - generic [ref=e1520]: Street
                              - textbox "Street" [ref=e1522]
                              - status
                            - generic [ref=e1523]:
                              - generic [ref=e1526]:
                                - generic [ref=e1527]: City
                                - textbox "City" [ref=e1529]
                              - generic [ref=e1532]:
                                - generic [ref=e1534]: State/Province
                                - generic [ref=e1538]:
                                  - combobox "State/Province" [ref=e1541]: "--None--"
                                  - img [ref=e1545]
                                - status
                            - generic [ref=e1551]:
                              - generic [ref=e1552]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e1554]
                  - generic [ref=e1557]:
                    - heading "Additional Information" [level=3] [ref=e1558]:
                      - generic [ref=e1559]: Additional Information
                    - list [ref=e1561]:
                      - generic [ref=e1562]:
                        - generic [ref=e1564]:
                          - listitem [ref=e1566]:
                            - generic [ref=e1573]:
                              - generic [ref=e1575]: Product Interest
                              - generic [ref=e1579]:
                                - combobox "Product Interest" [ref=e1580] [cursor=pointer]:
                                  - generic [ref=e1581]: "--None--"
                                - img [ref=e1585]
                              - status
                          - listitem [ref=e1589]:
                            - generic [ref=e1595]:
                              - generic [ref=e1596]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e1598]
                        - generic [ref=e1600]:
                          - listitem [ref=e1602]:
                            - generic [ref=e1608]:
                              - generic [ref=e1609]: SIC Code
                              - textbox "SIC Code" [ref=e1611]
                          - listitem [ref=e1613]:
                            - generic [ref=e1620]:
                              - generic [ref=e1622]: Primary
                              - generic [ref=e1626]:
                                - combobox "Primary" [ref=e1627] [cursor=pointer]:
                                  - generic [ref=e1628]: "--None--"
                                - img [ref=e1632]
                              - status
                        - listitem [ref=e1638]:
                          - generic [ref=e1643]:
                            - generic [ref=e1644]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e1646]
                  - generic [ref=e1649]:
                    - heading "Description Information" [level=3] [ref=e1650]:
                      - generic [ref=e1651]: Description Information
                    - list [ref=e1653]:
                      - listitem [ref=e1658]:
                        - generic [ref=e1662]:
                          - generic [ref=e1663]: Description
                          - textbox "Description" [ref=e1665]
                          - status
                - generic [ref=e1670]:
                  - generic "Cancel" [ref=e1671]:
                    - button "Cancel" [ref=e1676] [cursor=pointer]
                  - generic "Save & New" [ref=e1677]:
                    - button "Save & New" [ref=e1682] [cursor=pointer]
                  - generic "Save" [ref=e1683]:
                    - button "Save" [ref=e1688] [cursor=pointer]
          - status [ref=e1689]
  - generic:
    - status
```
