...
Call log:
  - waiting for getByRole('combobox', { name: 'Salutation' })
    - locator resolved to <button type="button" role="combobox" name="salutation" lwc-4kb6kaqheak="" part="input-button" aria-expanded="false" data-value="--None--" aria-disabled="false" aria-required="false" aria-haspopup="listbox" aria-label="Salutation" id="combobox-button-830" aria-describedby="help-text-829" aria-controls="dropdown-element-830" class="slds-combobox__input slds-input_faux fix-slds-input_faux slds-combobox__input-value">…</button>
        ...
        - main [ref=e316]:
          - generic [ref=e324]:
            ...
            - generic [ref=e397]:
              ...
              - generic [ref=e538]:
                - generic [ref=e540]:
                  - status [ref=e544]: 24 items • Filtered by Created Date, Me, Total Leads
                  - group [ref=e547]:
                    - generic [ref=e549]:
                ...
                - generic [ref=e568]:
                  ...
                  - grid [ref=e573]:
                    - generic [ref=e577]:
                      ...
                      - generic [ref=e580]:
                        - checkbox [ref=e581]
                        - generic [ref=e584]: Select 24 items
                    - generic [ref=e586]:
                        ...
                        - generic [ref=e1808]:
                          ...
                          - listitem [ref=e1826]:
                            ...
                            - generic [ref=e1837]:
                              ...
                              - textbox "Phone" [ref=e1840]: "0273614694"
                        - generic [ref=e1842]:
                          - listitem [ref=e1844]:
                            ...
                            - group "Name required" [ref=e1855]:
                              ...
                              - generic [ref=e1859]:
                                ...
                                - generic [ref=e1881]:
                                  ...
                                  - textbox "First Name" [ref=e1884]: Mario
                                - generic [ref=e1888]:
                                  - generic [ref=e1889]: "*Last Name"
                                  - textbox "Last Name" [ref=e1891]: Collier
                          - listitem [ref=e1893]:
                            - button "Undo Mobile" [ref=e1895] [cursor=pointer]:
                              - img [ref=e1897]
                            - generic [ref=e1904]:
                              - generic [ref=e1905]: Mobile
                              - textbox "Mobile" [ref=e1907]: "09862879962"
                        - generic [ref=e1909]:
                          - listitem [ref=e1911]:
                            ...
                            - generic [ref=e1923]:
                              ...
                              - textbox "Company" [ref=e1926]: Senger, Kub and Schneider
                          - listitem [ref=e1928]:
                            - button "Undo Fax" [ref=e1930] [cursor=pointer]:
                              - img [ref=e1932]
                            - generic [ref=e1939]:
                              - generic [ref=e1940]: Fax
                              - textbox "Fax" [ref=e1942]: "3331169687"
                        - generic [ref=e1944]:
                          - listitem [ref=e1946]:
                            ...
                            - generic [ref=e1958]:
                              ...
                              - textbox "Title" [ref=e1961]: International Usability Consultant
                          - listitem [ref=e1963]:
                            - button "Undo Email" [ref=e1965] [cursor=pointer]:
                              - img [ref=e1967]
                            - generic [ref=e1974]:
                              - generic [ref=e1975]: Email
                              - textbox "Email" [ref=e1977]: mario.collier@gmail.com
                        - generic [ref=e1979]:
                          - listitem [ref=e1981]:
                            - generic [ref=e1988]:
                              - generic [ref=e1990]: Lead Source
                              - generic [ref=e1994]:
                                - combobox "Lead Source" [ref=e1995] [cursor=pointer]:
                                  - generic [ref=e1996]: "--None--"
                                - img [ref=e2000]
                              - status
                          - listitem [ref=e2004]:
                            - button "Undo Website" [ref=e2006] [cursor=pointer]:
                              - img [ref=e2008]
                            - generic [ref=e2015]:
                              - generic [ref=e2016]: Website
                              - textbox "Website" [ref=e2018]: https://outlandish-lawmaker.org
                        - generic [ref=e2020]:
                          - listitem [ref=e2022]:
                            - generic [ref=e2029]:
                              - generic [ref=e2031]: Industry
                              - generic [ref=e2035]:
                                - combobox "Industry" [ref=e2036] [cursor=pointer]:
                                  - generic [ref=e2037]: "--None--"
                                - img [ref=e2041]
                              - status
                          - listitem [ref=e2045]:
                            - generic [ref=e2052]:
                              - generic [ref=e2054]: "*Lead Status"
                              - generic [ref=e2058]:
                                - combobox "Lead Status" [ref=e2059] [cursor=pointer]:
                                  - generic [ref=e2060]: Open - Not Contacted
                                - img [ref=e2064]
                              - status
                        - generic [ref=e2068]:
                          - listitem [ref=e2070]:
                            - button "Undo Annual Revenue" [ref=e2072] [cursor=pointer]:
                              - img [ref=e2074]
                            - generic [ref=e2082]:
                              - generic [ref=e2083]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e2085]: $569
                          - listitem [ref=e2087]:
                            - generic [ref=e2094]:
                              - generic [ref=e2096]: Rating
                              - generic [ref=e2100]:
                                - combobox "Rating" [ref=e2101] [cursor=pointer]:
                                  - generic [ref=e2102]: "--None--"
                                - img [ref=e2106]
                              - status
                        - listitem [ref=e2113]:
                          - button "Undo No. of Employees" [ref=e2115] [cursor=pointer]:
                            - img [ref=e2117]
                          - generic [ref=e2124]:
                            - generic [ref=e2125]: No. of Employees
                            - spinbutton "No. of Employees" [active] [ref=e2127]: "943"
                  - generic [ref=e2129]:
                    - heading "Address Information" [level=3] [ref=e2130]:
                      - generic [ref=e2131]: Address Information
                    - list [ref=e2133]:
                      - listitem [ref=e2138]:
                        - group "Address" [ref=e2143]:
                          - generic [ref=e2144]: Address
                          - generic [ref=e2146]:
                            - generic [ref=e2150]:
                              - generic [ref=e2152]: Country
                              - generic [ref=e2156]:
                                - combobox "Country" [ref=e2159]: "--None--"
                                - img [ref=e2163]
                              - status
                            - generic [ref=e2167]:
                              - generic [ref=e2168]: Street
                              - textbox "Street" [ref=e2170]
                              - status
                            - generic [ref=e2171]:
                              - generic [ref=e2174]:
                                - generic [ref=e2175]: City
                                - textbox "City" [ref=e2177]
                              - generic [ref=e2180]:
                                - generic [ref=e2182]: State/Province
                                - generic [ref=e2186]:
                                  - combobox "State/Province" [ref=e2189]: "--None--"
                                  - img [ref=e2193]
                                - status
                            - generic [ref=e2199]:
                              - generic [ref=e2200]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e2202]
                  - generic [ref=e2205]:
                    - heading "Additional Information" [level=3] [ref=e2206]:
                      - generic [ref=e2207]: Additional Information
                    - list [ref=e2209]:
                      - generic [ref=e2210]:
                        - generic [ref=e2212]:
                          - listitem [ref=e2214]:
                            - generic [ref=e2221]:
                              - generic [ref=e2223]: Product Interest
                              - generic [ref=e2227]:
                                - combobox "Product Interest" [ref=e2228] [cursor=pointer]:
                                  - generic [ref=e2229]: "--None--"
                                - img [ref=e2233]
                              - status
                          - listitem [ref=e2237]:
                            - generic [ref=e2243]:
                              - generic [ref=e2244]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e2246]
                        - generic [ref=e2248]:
                          - listitem [ref=e2250]:
                            - generic [ref=e2256]:
                              - generic [ref=e2257]: SIC Code
                              - textbox "SIC Code" [ref=e2259]
                          - listitem [ref=e2261]:
                            - generic [ref=e2268]:
                              - generic [ref=e2270]: Primary
                              - generic [ref=e2274]:
                                - combobox "Primary" [ref=e2275] [cursor=pointer]:
                                  - generic [ref=e2276]: "--None--"
                                - img [ref=e2280]
                              - status
                        - listitem [ref=e2286]:
                          - generic [ref=e2291]:
                            - generic [ref=e2292]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e2294]
                  - generic [ref=e2297]:
                    - heading "Description Information" [level=3] [ref=e2298]:
                      - generic [ref=e2299]: Description Information
                    - list [ref=e2301]:
                      - listitem [ref=e2306]:
                        - generic [ref=e2310]:
                          - generic [ref=e2311]: Description
                          - textbox "Description" [ref=e2313]
                          - status
                - generic [ref=e2318]:
                  - generic "Cancel" [ref=e2319]:
                    - button "Cancel" [ref=e2324] [cursor=pointer]
                  - generic "Save & New" [ref=e2325]:
                    - button "Save & New" [ref=e2330] [cursor=pointer]
                  - generic "Save" [ref=e2331]:
                    - button "Save" [ref=e2336] [cursor=pointer]
          - status [ref=e2337]
  - generic:
    - status
```
