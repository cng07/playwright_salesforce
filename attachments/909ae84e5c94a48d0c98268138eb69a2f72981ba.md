...
Call log:
  - waiting for getByRole('textbox', { name: 'Title' })
    - locator resolved to <input type="text" part="input" name="Title" id="input-852" maxlength="128" lwc-enmikoh2qu="" class="slds-input" aria-describedby="help-message-852"/>
                  ...
                  - generic [ref=e1801]:
                    ...
                    - list [ref=e1805]:
                      - generic [ref=e1806]:
                        ...
                        - generic [ref=e1836]:
                          - listitem [ref=e1838]:
                            - button "Undo Name" [ref=e1840] [cursor=pointer]:
                              - img [ref=e1842]
                            - group "Name required" [ref=e1849]:
                              - generic [ref=e1850]:
                                - text: "*Name"
                                - generic "required" [ref=e1851]
                              - generic [ref=e1853]:
                                - generic [ref=e1857]:
                                  - generic [ref=e1859]: Salutation
                                  - generic [ref=e1863]:
                                    - combobox "Salutation" [ref=e1864] [cursor=pointer]:
                                      - generic [ref=e1865]: "--None--"
                                    - img [ref=e1869]
                                  - status
                                - generic [ref=e1875]:
                                  - generic [ref=e1876]: First Name
                                  - textbox "First Name" [ref=e1878]: Norene
                                - generic [ref=e1882]:
                                  - generic [ref=e1883]: "*Last Name"
                                  - textbox "Last Name" [ref=e1885]: O'Keefe
                          - listitem [ref=e1887]:
                            - generic [ref=e1892]:
                              - generic [ref=e1893]: Mobile
                              - textbox "Mobile" [ref=e1895]
                        - generic [ref=e1897]:
                          - listitem [ref=e1899]:
                            - button "Undo Company" [ref=e1901] [cursor=pointer]:
                              - img [ref=e1903]
                            - generic [ref=e1911]:
                              - generic [ref=e1912]: "*Company"
                              - textbox "Company" [active] [ref=e1914]: Paucek, Prohaska and Goldner
                          - listitem [ref=e1916]:
                            - generic [ref=e1921]:
                              - generic [ref=e1922]: Fax
                              - textbox "Fax" [ref=e1924]
                        - generic [ref=e1926]:
                          - listitem [ref=e1928]:
                            - generic [ref=e1934]:
                              - generic [ref=e1935]: Title
                              - textbox "Title" [ref=e1937]
                          - listitem [ref=e1939]:
                            - generic [ref=e1944]:
                              - generic [ref=e1945]: Email
                              - textbox "Email" [ref=e1947]
                        - generic [ref=e1949]:
                          - listitem [ref=e1951]:
                            - generic [ref=e1958]:
                              - generic [ref=e1960]: Lead Source
                              - generic [ref=e1964]:
                                - combobox "Lead Source" [ref=e1965] [cursor=pointer]:
                                  - generic [ref=e1966]: "--None--"
                                - img [ref=e1970]
                              - status
                          - listitem [ref=e1974]:
                            - generic [ref=e1979]:
                              - generic [ref=e1980]: Website
                              - textbox "Website" [ref=e1982]
                        - generic [ref=e1984]:
                          - listitem [ref=e1986]:
                            - generic [ref=e1993]:
                              - generic [ref=e1995]: Industry
                              - generic [ref=e1999]:
                                - combobox "Industry" [ref=e2000] [cursor=pointer]:
                                  - generic [ref=e2001]: "--None--"
                                - img [ref=e2005]
                              - status
                          - listitem [ref=e2009]:
                            - generic [ref=e2016]:
                              - generic [ref=e2018]: "*Lead Status"
                              - generic [ref=e2022]:
                                - combobox "Lead Status" [ref=e2023] [cursor=pointer]:
                                  - generic [ref=e2024]: Open - Not Contacted
                                - img [ref=e2028]
                              - status
                        - generic [ref=e2032]:
                          - listitem [ref=e2034]:
                            - generic [ref=e2040]:
                              - generic [ref=e2041]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e2043]
                          - listitem [ref=e2045]:
                            - generic [ref=e2052]:
                              - generic [ref=e2054]: Rating
                              - generic [ref=e2058]:
                                - combobox "Rating" [ref=e2059] [cursor=pointer]:
                                  - generic [ref=e2060]: "--None--"
                                - img [ref=e2064]
                              - status
                        - listitem [ref=e2071]:
                          - generic [ref=e2076]:
                            - generic [ref=e2077]: No. of Employees
                            - spinbutton "No. of Employees" [ref=e2079]
                  - generic [ref=e2081]:
                    - heading "Address Information" [level=3] [ref=e2082]:
                      - generic [ref=e2083]: Address Information
                    - list [ref=e2085]:
                      - listitem [ref=e2090]:
                        - group "Address" [ref=e2095]:
                          - generic [ref=e2096]: Address
                          - generic [ref=e2098]:
                            - generic [ref=e2102]:
                              - generic [ref=e2104]: Country
                              - generic [ref=e2108]:
                                - combobox "Country" [ref=e2111]: "--None--"
                                - img [ref=e2115]
                              - status
                            - generic [ref=e2119]:
                              - generic [ref=e2120]: Street
                              - textbox "Street" [ref=e2122]
                              - status
                            - generic [ref=e2123]:
                              - generic [ref=e2126]:
                                - generic [ref=e2127]: City
                                - textbox "City" [ref=e2129]
                              - generic [ref=e2132]:
                                - generic [ref=e2134]: State/Province
                                - generic [ref=e2138]:
                                  - combobox "State/Province" [ref=e2141]: "--None--"
                                  - img [ref=e2145]
                                - status
                            - generic [ref=e2151]:
                              - generic [ref=e2152]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e2154]
                  - generic [ref=e2157]:
                    - heading "Additional Information" [level=3] [ref=e2158]:
                      - generic [ref=e2159]: Additional Information
                    - list [ref=e2161]:
                      - generic [ref=e2162]:
                        - generic [ref=e2164]:
                          - listitem [ref=e2166]:
                            - generic [ref=e2173]:
                              - generic [ref=e2175]: Product Interest
                              - generic [ref=e2179]:
                                - combobox "Product Interest" [ref=e2180] [cursor=pointer]:
                                  - generic [ref=e2181]: "--None--"
                                - img [ref=e2185]
                              - status
                          - listitem [ref=e2189]:
                            - generic [ref=e2195]:
                              - generic [ref=e2196]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e2198]
                        - generic [ref=e2200]:
                          - listitem [ref=e2202]:
                            - generic [ref=e2208]:
                              - generic [ref=e2209]: SIC Code
                              - textbox "SIC Code" [ref=e2211]
                          - listitem [ref=e2213]:
                            - generic [ref=e2220]:
                              - generic [ref=e2222]: Primary
                              - generic [ref=e2226]:
                                - combobox "Primary" [ref=e2227] [cursor=pointer]:
                                  - generic [ref=e2228]: "--None--"
                                - img [ref=e2232]
                              - status
                        - listitem [ref=e2238]:
                          - generic [ref=e2243]:
                            - generic [ref=e2244]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e2246]
                  - generic [ref=e2249]:
                    - heading "Description Information" [level=3] [ref=e2250]:
                      - generic [ref=e2251]: Description Information
                    - list [ref=e2253]:
                      - listitem [ref=e2258]:
                        - generic [ref=e2262]:
                          - generic [ref=e2263]: Description
                          - textbox "Description" [ref=e2265]
                          - status
                - generic [ref=e2270]:
                  - generic "Cancel" [ref=e2271]:
                    - button "Cancel" [ref=e2276] [cursor=pointer]
                  - generic "Save & New" [ref=e2277]:
                    - button "Save & New" [ref=e2282] [cursor=pointer]
                  - generic "Save" [ref=e2283]:
                    - button "Save" [ref=e2288] [cursor=pointer]
          - status [ref=e2289]
  - generic:
    - status
```
