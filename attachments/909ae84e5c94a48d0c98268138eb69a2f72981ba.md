...
Call log:
  - waiting for getByRole('textbox', { name: 'Mobile' })
    - locator resolved to <input type="text" part="input" id="input-839" maxlength="40" lwc-enmikoh2qu="" class="slds-input" name="MobilePhone" aria-describedby="help-message-839"/>
    - fill("09329140101")
                        ...
                        - generic [ref=e1808]:
                          ...
                          - listitem [ref=e1826]:
                            ...
                            - generic [ref=e1837]:
                              ...
                              - textbox "Phone" [active] [ref=e1840]: "0295720290"
                        - generic [ref=e1842]:
                          - listitem [ref=e1844]:
                            ...
                            - group "Name required" [ref=e1855]:
                              ...
                              - generic [ref=e1859]:
                                ...
                                - generic [ref=e1881]:
                                  ...
                                  - textbox "First Name" [ref=e1884]: Garrett
                                - generic [ref=e1888]:
                                  - generic [ref=e1889]: "*Last Name"
                                  - textbox "Last Name" [ref=e1891]: Greenholt
                          - listitem [ref=e1893]:
                            - generic [ref=e1898]:
                              - generic [ref=e1899]: Mobile
                              - textbox "Mobile" [ref=e1901]
                        - generic [ref=e1903]:
                          - listitem [ref=e1905]:
                            - button "Undo Company" [ref=e1907] [cursor=pointer]:
                              - img [ref=e1909]
                            - generic [ref=e1917]:
                              - generic [ref=e1918]: "*Company"
                              - textbox "Company" [ref=e1920]: Schulist-Gerlach - Shields
                          - listitem [ref=e1922]:
                            - generic [ref=e1927]:
                              - generic [ref=e1928]: Fax
                              - textbox "Fax" [ref=e1930]
                        - generic [ref=e1932]:
                          - listitem [ref=e1934]:
                            - button "Undo Title" [ref=e1936] [cursor=pointer]:
                              - img [ref=e1938]
                            - generic [ref=e1946]:
                              - generic [ref=e1947]: Title
                              - textbox "Title" [ref=e1949]: Senior Functionality Engineer
                          - listitem [ref=e1951]:
                            - generic [ref=e1956]:
                              - generic [ref=e1957]: Email
                              - textbox "Email" [ref=e1959]
                        - generic [ref=e1961]:
                          - listitem [ref=e1963]:
                            - generic [ref=e1970]:
                              - generic [ref=e1972]: Lead Source
                              - generic [ref=e1976]:
                                - combobox "Lead Source" [ref=e1977] [cursor=pointer]:
                                  - generic [ref=e1978]: "--None--"
                                - img [ref=e1982]
                              - status
                          - listitem [ref=e1986]:
                            - generic [ref=e1991]:
                              - generic [ref=e1992]: Website
                              - textbox "Website" [ref=e1994]
                        - generic [ref=e1996]:
                          - listitem [ref=e1998]:
                            - generic [ref=e2005]:
                              - generic [ref=e2007]: Industry
                              - generic [ref=e2011]:
                                - combobox "Industry" [ref=e2012] [cursor=pointer]:
                                  - generic [ref=e2013]: "--None--"
                                - img [ref=e2017]
                              - status
                          - listitem [ref=e2021]:
                            - generic [ref=e2028]:
                              - generic [ref=e2030]: "*Lead Status"
                              - generic [ref=e2034]:
                                - combobox "Lead Status" [ref=e2035] [cursor=pointer]:
                                  - generic [ref=e2036]: Open - Not Contacted
                                - img [ref=e2040]
                              - status
                        - generic [ref=e2044]:
                          - listitem [ref=e2046]:
                            - button "Undo Annual Revenue" [ref=e2048] [cursor=pointer]:
                              - img [ref=e2050]
                            - generic [ref=e2058]:
                              - generic [ref=e2059]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e2061]: $894
                          - listitem [ref=e2063]:
                            - generic [ref=e2070]:
                              - generic [ref=e2072]: Rating
                              - generic [ref=e2076]:
                                - combobox "Rating" [ref=e2077] [cursor=pointer]:
                                  - generic [ref=e2078]: "--None--"
                                - img [ref=e2082]
                              - status
                        - listitem [ref=e2089]:
                          - generic [ref=e2094]:
                            - generic [ref=e2095]: No. of Employees
                            - spinbutton "No. of Employees" [ref=e2097]
                  - generic [ref=e2099]:
                    - heading "Address Information" [level=3] [ref=e2100]:
                      - generic [ref=e2101]: Address Information
                    - list [ref=e2103]:
                      - listitem [ref=e2108]:
                        - group "Address" [ref=e2113]:
                          - generic [ref=e2114]: Address
                          - generic [ref=e2116]:
                            - generic [ref=e2120]:
                              - generic [ref=e2122]: Country
                              - generic [ref=e2126]:
                                - combobox "Country" [ref=e2129]: "--None--"
                                - img [ref=e2133]
                              - status
                            - generic [ref=e2137]:
                              - generic [ref=e2138]: Street
                              - textbox "Street" [ref=e2140]
                              - status
                            - generic [ref=e2141]:
                              - generic [ref=e2144]:
                                - generic [ref=e2145]: City
                                - textbox "City" [ref=e2147]
                              - generic [ref=e2150]:
                                - generic [ref=e2152]: State/Province
                                - generic [ref=e2156]:
                                  - combobox "State/Province" [ref=e2159]: "--None--"
                                  - img [ref=e2163]
                                - status
                            - generic [ref=e2169]:
                              - generic [ref=e2170]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e2172]
                  - generic [ref=e2175]:
                    - heading "Additional Information" [level=3] [ref=e2176]:
                      - generic [ref=e2177]: Additional Information
                    - list [ref=e2179]:
                      - generic [ref=e2180]:
                        - generic [ref=e2182]:
                          - listitem [ref=e2184]:
                            - generic [ref=e2191]:
                              - generic [ref=e2193]: Product Interest
                              - generic [ref=e2197]:
                                - combobox "Product Interest" [ref=e2198] [cursor=pointer]:
                                  - generic [ref=e2199]: "--None--"
                                - img [ref=e2203]
                              - status
                          - listitem [ref=e2207]:
                            - generic [ref=e2213]:
                              - generic [ref=e2214]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e2216]
                        - generic [ref=e2218]:
                          - listitem [ref=e2220]:
                            - generic [ref=e2226]:
                              - generic [ref=e2227]: SIC Code
                              - textbox "SIC Code" [ref=e2229]
                          - listitem [ref=e2231]:
                            - generic [ref=e2238]:
                              - generic [ref=e2240]: Primary
                              - generic [ref=e2244]:
                                - combobox "Primary" [ref=e2245] [cursor=pointer]:
                                  - generic [ref=e2246]: "--None--"
                                - img [ref=e2250]
                              - status
                        - listitem [ref=e2256]:
                          - generic [ref=e2261]:
                            - generic [ref=e2262]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e2264]
                  - generic [ref=e2267]:
                    - heading "Description Information" [level=3] [ref=e2268]:
                      - generic [ref=e2269]: Description Information
                    - list [ref=e2271]:
                      - listitem [ref=e2276]:
                        - generic [ref=e2280]:
                          - generic [ref=e2281]: Description
                          - textbox "Description" [ref=e2283]
                          - status
                - generic [ref=e2288]:
                  - generic "Cancel" [ref=e2289]:
                    - button "Cancel" [ref=e2294] [cursor=pointer]
                  - generic "Save & New" [ref=e2295]:
                    - button "Save & New" [ref=e2300] [cursor=pointer]
                  - generic "Save" [ref=e2301]:
                    - button "Save" [ref=e2306] [cursor=pointer]
          - status [ref=e2307]
  - generic:
    - status
```
