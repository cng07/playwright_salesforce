...
Call log:
  ...
  - waiting for getByText('was created.')
    3 × locator resolved to <span data-aura-rendered-by="1312:0" data-aura-class="forceActionsText" class="toastMessage slds-text-heading--small forceActionsText">…</span>
...
- main:
  - heading "Lead Mrs. Jamie Pollich" [level=1]
  - button "Follow"
  - button "New Case"
  - button "New Note"
  ...
  - paragraph: Title
  - paragraph: Dynamic Paradigm Supervisor
  - paragraph: Company
  - paragraph: Gleason, Littel and Kuphal
  - button "Phone (2)":
    - paragraph: Phone (2)
  - list:
    - paragraph:
  ...
  - paragraph: Email
  - paragraph:
    - link "jamie_pollich@gmail.com":
      - /url: mailto:jamie_pollich@gmail.com
  ...
  - tabpanel "Related":
    - article:
      - heading "Campaign History" [level=2]
- contentinfo "Utility Bar":
  - list:
    - listitem:
      - button "To Do List"
- text: Success notification. Lead "
- link "Mrs. Jamie Pollich":
  - /url: javascript:void(0)
- text: "\" was created. Press Command + F6 to navigate to the next toast notification or focusable region."
- button "Close"
- status
```
