...
Call log:
  - waiting for getByRole('combobox', { name: 'Lead Status' })
    - locator resolved to <button type="button" role="combobox" lwc-4kb6kaqheak="" part="input-button" aria-required="true" aria-expanded="false" aria-disabled="false" aria-haspopup="listbox" id="combobox-button-882" aria-label="Lead Status" data-value="Open - Not Contacted" aria-controls="dropdown-element-882" class="slds-combobox__input slds-input_faux fix-slds-input_faux slds-combobox__input-value">…</button>
                        ...
                        - generic [ref=e1808]:
                          ...
                          - listitem [ref=e1826]:
                            ...
                            - generic [ref=e1837]:
                              ...
                              - textbox "Phone" [ref=e1840]: "0203409299"
                        - generic [ref=e1842]:
                          - listitem [ref=e1844]:
                                ...
                                - generic [ref=e1863]:
                                  ...
                                  - generic [ref=e1869]:
                                    - combobox "Salutation" [ref=e1870] [cursor=pointer]:
                                      - generic [ref=e1871]: Prof.
                                    - img [ref=e1875]
                                  - status
                                - generic [ref=e1881]:
                                  - generic [ref=e1882]: First Name
                                  - textbox "First Name" [ref=e1884]: Matt
                                - generic [ref=e1888]:
                                  - generic [ref=e1889]: "*Last Name"
                                  - textbox "Last Name" [ref=e1891]: McDermott-Labadie
                          - listitem [ref=e1893]:
                            - button "Undo Mobile" [ref=e1895] [cursor=pointer]:
                              - img [ref=e1897]
                            - generic [ref=e1904]:
                              - generic [ref=e1905]: Mobile
                              - textbox "Mobile" [ref=e1907]: "09629141971"
                        - generic [ref=e1909]:
                          - listitem [ref=e1911]:
                            ...
                            - generic [ref=e1923]:
                              ...
                              - textbox "Company" [ref=e1926]: Sanford and Sons
                          - listitem [ref=e1928]:
                            - button "Undo Fax" [ref=e1930] [cursor=pointer]:
                              - img [ref=e1932]
                            - generic [ref=e1939]:
                              - generic [ref=e1940]: Fax
                              - textbox "Fax" [ref=e1942]: "2694299331"
                        - generic [ref=e1944]:
                          - listitem [ref=e1946]:
                            ...
                            - generic [ref=e1958]:
                              ...
                              - textbox "Title" [ref=e1961]: Product Infrastructure Strategist
                          - listitem [ref=e1963]:
                            - button "Undo Email" [ref=e1965] [cursor=pointer]:
                              - img [ref=e1967]
                            - generic [ref=e1974]:
                              - generic [ref=e1975]: Email
                              - textbox "Email" [ref=e1977]: matt.mcdermott-labadie5@hotmail.com
                        - generic [ref=e1979]:
                          - listitem [ref=e1981]:
                          ...
                          - listitem [ref=e2010]:
                            ...
                            - generic [ref=e2021]:
                              ...
                              - textbox "Website" [ref=e2024]: https://lighthearted-vol.biz/
                        - generic [ref=e2026]:
                          - listitem [ref=e2028]:
                          ...
                          - listitem [ref=e2057]:
                            - generic [ref=e2064]:
                              ...
                              - generic [ref=e2070]:
                                - combobox "Lead Status" [active] [ref=e2071] [cursor=pointer]:
                                  - generic [ref=e2072]: Open - Not Contacted
                                - img [ref=e2076]
                              - status
                        - generic [ref=e2080]:
                          - listitem [ref=e2082]:
                            - button "Undo Annual Revenue" [ref=e2084] [cursor=pointer]:
                              - img [ref=e2086]
                            - generic [ref=e2094]:
                              - generic [ref=e2095]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e2097]: $437
                          - listitem [ref=e2099]:
                            - generic [ref=e2106]:
                              - generic [ref=e2108]: Rating
                              - generic [ref=e2112]:
                                - combobox "Rating" [ref=e2113] [cursor=pointer]:
                                  - generic [ref=e2114]: "--None--"
                                - img [ref=e2118]
                              - status
                        - listitem [ref=e2125]:
                          - button "Undo No. of Employees" [ref=e2127] [cursor=pointer]:
                            - img [ref=e2129]
                          - generic [ref=e2136]:
                            - generic [ref=e2137]: No. of Employees
                            - spinbutton "No. of Employees" [ref=e2139]: "551"
                  - generic [ref=e2141]:
                    - heading "Address Information" [level=3] [ref=e2142]:
                      - generic [ref=e2143]: Address Information
                    - list [ref=e2145]:
                      - listitem [ref=e2150]:
                        - group "Address" [ref=e2155]:
                          - generic [ref=e2156]: Address
                          - generic [ref=e2158]:
                            - generic [ref=e2162]:
                              - generic [ref=e2164]: Country
                              - generic [ref=e2168]:
                                - combobox "Country" [ref=e2171]: "--None--"
                                - img [ref=e2175]
                              - status
                            - generic [ref=e2179]:
                              - generic [ref=e2180]: Street
                              - textbox "Street" [ref=e2182]
                              - status
                            - generic [ref=e2183]:
                              - generic [ref=e2186]:
                                - generic [ref=e2187]: City
                                - textbox "City" [ref=e2189]
                              - generic [ref=e2192]:
                                - generic [ref=e2194]: State/Province
                                - generic [ref=e2198]:
                                  - combobox "State/Province" [ref=e2201]: "--None--"
                                  - img [ref=e2205]
                                - status
                            - generic [ref=e2211]:
                              - generic [ref=e2212]: Zip/Postal Code
                              - textbox "Zip/Postal Code" [ref=e2214]
                  - generic [ref=e2217]:
                    - heading "Additional Information" [level=3] [ref=e2218]:
                      - generic [ref=e2219]: Additional Information
                    - list [ref=e2221]:
                      - generic [ref=e2222]:
                        - generic [ref=e2224]:
                          - listitem [ref=e2226]:
                            - generic [ref=e2233]:
                              - generic [ref=e2235]: Product Interest
                              - generic [ref=e2239]:
                                - combobox "Product Interest" [ref=e2240] [cursor=pointer]:
                                  - generic [ref=e2241]: "--None--"
                                - img [ref=e2245]
                              - status
                          - listitem [ref=e2249]:
                            - generic [ref=e2255]:
                              - generic [ref=e2256]: Current Generator(s)
                              - textbox "Current Generator(s)" [ref=e2258]
                        - generic [ref=e2260]:
                          - listitem [ref=e2262]:
                            - generic [ref=e2268]:
                              - generic [ref=e2269]: SIC Code
                              - textbox "SIC Code" [ref=e2271]
                          - listitem [ref=e2273]:
                            - generic [ref=e2280]:
                              - generic [ref=e2282]: Primary
                              - generic [ref=e2286]:
                                - combobox "Primary" [ref=e2287] [cursor=pointer]:
                                  - generic [ref=e2288]: "--None--"
                                - img [ref=e2292]
                              - status
                        - listitem [ref=e2298]:
                          - generic [ref=e2303]:
                            - generic [ref=e2304]: Number of Locations
                            - spinbutton "Number of Locations" [ref=e2306]
                  - generic [ref=e2309]:
                    - heading "Description Information" [level=3] [ref=e2310]:
                      - generic [ref=e2311]: Description Information
                    - list [ref=e2313]:
                      - listitem [ref=e2318]:
                        - generic [ref=e2322]:
                          - generic [ref=e2323]: Description
                          - textbox "Description" [ref=e2325]
                          - status
                - generic [ref=e2330]:
                  - generic "Cancel" [ref=e2331]:
                    - button "Cancel" [ref=e2336] [cursor=pointer]
                  - generic "Save & New" [ref=e2337]:
                    - button "Save & New" [ref=e2342] [cursor=pointer]
                  - generic "Save" [ref=e2343]:
                    - button "Save" [ref=e2348] [cursor=pointer]
          - status [ref=e2349]
  - generic:
    - status
```
